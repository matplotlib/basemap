...
boundaryfiles = glob.glob('lib/matplotlib/toolkits/basemap/data/*_c.dat')
boundaryfiles = boundaryfiles + glob.glob('lib/matplotlib/toolkits/basemap/data/*_l.dat')
boundaryfiles = boundaryfiles + glob.glob('lib/matplotlib/toolkits/basemap/data/*_i.dat')
boundaryfiles = boundaryfiles + glob.glob('lib/matplotlib/toolkits/basemap/data/*_h.dat')

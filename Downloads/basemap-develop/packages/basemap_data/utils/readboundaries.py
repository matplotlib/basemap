...
for resolution in ['c', 'l', 'i', 'h', 'f']:
    ...
    f2 = open('../lib/mpl_toolkits/basemap/data/gshhsmeta_' +
              resolution + '.dat', 'w')
    offset = 0
    ...
    f = open('../lib/mpl_toolkits/basemap/data/countries_' +
             resolution + '.dat', 'wb')
    f2 = open('../lib/mpl_toolkits/basemap/data/countriesmeta_' +
              resolution + '.dat', 'w')
    offset = 0
    for p, pm in zip(poly, polymeta):
        bstring = p.tostring()
    ...
    f2 = open('../lib/mpl_toolkits/basemap/data/statesmeta_' +
              resolution + '.dat', 'w')
    offset = 0
    for p, pm in zip(poly, polymeta):
        bstring = p.tostring()
    ...
    f2 = open('../lib/mpl_toolkits/basemap/data/riversmeta_' +
              resolution + '.dat', 'w')
    offset = 0
    for p, pm in zip(poly, polymeta):
        bstring = p.tostring()

...
gmt gshhg -A${area} $gshhs_dir/gshhs_c.b > gshhs_c.txt
gmt gshhg -A${area} $gshhs_dir/gshhs_l.b > gshhs_l.txt
gmt gshhg -A${area} $gshhs_dir/gshhs_i.b > gshhs_i.txt
gmt gshhg -A${area} $gshhs_dir/gshhs_h.b > gshhs_h.txt
gmt gshhg -A${area} $gshhs_dir/gshhs_f.b > gshhs_f.txt

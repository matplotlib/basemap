 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/_geos.pyx":302
 *         bbuffer[2*i] = dx
 *         bbuffer[2*i+1] = dy
 *     return b             # <<<<<<<<<<<<<< 
 * 
...
static int __pyx_f_py_5_geos_10LineString___init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  Py_INCREF((PyObject *)__pyx_v_self);
  Py_INCREF(__pyx_v_b);
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_b), __pyx_ptype_5_geos_ndarray, 1, "b"))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 305; goto __pyx_L1;}
 ...
 *         M = b.shape[0]
 */
    __pyx_2 = PyObject_GetAttr(((PyObject *)__pyx_v_b), __pyx_n_copy); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 318; goto __pyx_L1;}
    __pyx_3 = PyObject_CallObject(__pyx_2, 0); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 318; goto __pyx_L1;}
    Py_DECREF(__pyx_2); __pyx_2 = 0;
    if (!__Pyx_TypeTest(__pyx_3, __pyx_ptype_5_geos_ndarray)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 318; goto __pyx_L1;}
    Py_DECREF(((PyObject *)__pyx_v_b));
    __pyx_v_b = ((PyArrayObject *)__pyx_3);
    __pyx_3 = 0;
    goto __pyx_L3;
 ...
 * 
 */
  __pyx_2 = PyObject_GetAttr(((PyObject *)__pyx_v_b), __pyx_n_shape); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 320; goto __pyx_L1;}
  if (PyList_CheckExact(__pyx_2) && 0 <= 0 && 0 < PyList_GET_SIZE(__pyx_2)) {
    __pyx_4 = PyList_GET_ITEM(__pyx_2, 0); Py_INCREF(__pyx_4);
    } else if (PyTuple_CheckExact(__pyx_2) && 0 <= 0 && 0 < PyTuple_GET_SIZE(__pyx_2)) {
    __pyx_4 = PyTuple_GET_ITEM(__pyx_2, 0); Py_INCREF(__pyx_4);
    } else {
    __pyx_3 = PyInt_FromLong(0); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 320; goto __pyx_L1;}
    __pyx_4 = PyObject_GetItem(__pyx_2, __pyx_3); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 320; goto __pyx_L1;}
    Py_DECREF(__pyx_3); __pyx_3 = 0;
  }
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  __pyx_5 = PyInt_AsLong(__pyx_4); if (unlikely((__pyx_5 == -1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 320; goto __pyx_L1;}
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  __pyx_v_M = __pyx_5;

  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/_geos.pyx":321
 * 
 *         M = b.shape[0]
 *         self._npts = M             # <<<<<<<<<<<<<< 
 * 
...
static int __pyx_f_py_5_geos_5Point___init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/_geos.pyx":346
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/_geos.pyx":347
 *         # just return an empty class
 *         if b is None:
 *             return             # <<<<<<<<<<<<<< 
 *         # Create a coordinate sequence
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/_geos.pyx":349
 *             return
 *         # Create a coordinate sequence
 *         cs = GEOSCoordSeq_create(1, 2)             # <<<<<<<<<<<<<< 
 *         dx = b[0]; dy = b[1]
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/_geos.pyx":350
 *         # Create a coordinate sequence
 *         cs = GEOSCoordSeq_create(1, 2)
 *         dx = b[0]; dy = b[1]             # <<<<<<<<<<<<<< 
 *         GEOSCoordSeq_setX(cs, 0, dx)
 ...
 */
  if (PyList_CheckExact(__pyx_v_b) && 0 <= 0 && 0 < PyList_GET_SIZE(__pyx_v_b)) {
    ...
    __pyx_2 = PyInt_FromLong(0); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 350; goto __pyx_L1;}
    __pyx_3 = PyObject_GetItem(__pyx_v_b, __pyx_2); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 350; goto __pyx_L1;}
    Py_DECREF(__pyx_2); __pyx_2 = 0;
  }
  __pyx_4 = PyFloat_AsDouble(__pyx_3); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 350; goto __pyx_L1;}
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  __pyx_v_dx = __pyx_4;
 ...
 */
  if (PyList_CheckExact(__pyx_v_b) && 0 <= 1 && 1 < PyList_GET_SIZE(__pyx_v_b)) {
    ...
    __pyx_2 = PyInt_FromLong(1); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 350; goto __pyx_L1;}
    __pyx_3 = PyObject_GetItem(__pyx_v_b, __pyx_2); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 350; goto __pyx_L1;}
    Py_DECREF(__pyx_2); __pyx_2 = 0;
  }
  __pyx_4 = PyFloat_AsDouble(__pyx_3); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 350; goto __pyx_L1;}
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/_geos.pyx":351
 *         cs = GEOSCoordSeq_create(1, 2)
 *         dx = b[0]; dy = b[1]
 *         GEOSCoordSeq_setX(cs, 0, dx)             # <<<<<<<<<<<<<< 
 *         GEOSCoordSeq_setY(cs, 0, dy)
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/_geos.pyx":352
 *         dx = b[0]; dy = b[1]
 *         GEOSCoordSeq_setX(cs, 0, dx)
 *         GEOSCoordSeq_setY(cs, 0, dy)             # <<<<<<<<<<<<<< 
 *         self._geom = GEOSGeom_createPoint(cs)
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/_geos.pyx":353
 *         GEOSCoordSeq_setX(cs, 0, dx)
 *         GEOSCoordSeq_setY(cs, 0, dy)
 *         self._geom = GEOSGeom_createPoint(cs)             # <<<<<<<<<<<<<< 
 *         self._npts = 1
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/_geos.pyx":354
 *         GEOSCoordSeq_setY(cs, 0, dy)
 *         self._geom = GEOSGeom_createPoint(cs)
 *         self._npts = 1             # <<<<<<<<<<<<<< 
 *         self.boundary = b
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/_geos.pyx":355
 *         self._geom = GEOSGeom_createPoint(cs)
 *         self._npts = 1
 *         self.boundary = b             # <<<<<<<<<<<<<< 
 */
...
PyMODINIT_FUNC init_geos(void) {
  ...
  __pyx_builtin_NotImplementedError = __Pyx_GetName(__pyx_b, __pyx_n_NotImplementedError); if (!__pyx_builtin_NotImplementedError) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 194; goto __pyx_L1;}
  ...
  if (PyType_Ready(&__pyx_type_5_geos_Polygon) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 208; goto __pyx_L1;}
  if (PyObject_SetAttrString(__pyx_m, "Polygon", (PyObject *)&__pyx_type_5_geos_Polygon) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 208; goto __pyx_L1;}
  __pyx_ptype_5_geos_Polygon = &__pyx_type_5_geos_Polygon;
  __pyx_type_5_geos_LineString.tp_base = __pyx_ptype_5_geos_BaseGeometry;
  if (PyType_Ready(&__pyx_type_5_geos_LineString) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 304; goto __pyx_L1;}
  if (PyObject_SetAttrString(__pyx_m, "LineString", (PyObject *)&__pyx_type_5_geos_LineString) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 304; goto __pyx_L1;}
  ...
  if (PyType_Ready(&__pyx_type_5_geos_Point) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 340; goto __pyx_L1;}
  if (PyObject_SetAttrString(__pyx_m, "Point", (PyObject *)&__pyx_type_5_geos_Point) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 340; goto __pyx_L1;}
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/_geos.pyx":210
 * cdef class Polygon(BaseGeometry):
 * 

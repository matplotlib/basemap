/* Generated by Cython 0.15.1 on Tue Apr  3 09:52:00 2012 */
 ...
 */
  ((struct __pyx_obj_5_proj_Proj *)__pyx_v_self)->projctx = pj_ctx_alloc();
 ...
 *         if err != 0:
 */
  ((struct __pyx_obj_5_proj_Proj *)__pyx_v_self)->projpj = pj_init_plus_ctx(((struct __pyx_obj_5_proj_Proj *)__pyx_v_self)->projctx, ((struct __pyx_obj_5_proj_Proj *)__pyx_v_self)->pjinitstring);
 ...
 */
  __pyx_v_err = pj_ctx_get_errno(((struct __pyx_obj_5_proj_Proj *)__pyx_v_self)->projctx);
 ...
 *     def __reduce__(self):
 */
  pj_ctx_free(((struct __pyx_obj_5_proj_Proj *)__pyx_v_self)->projctx);
...
static PyObject *__pyx_pf_5_proj_4Proj_3_fwd(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_fwd");
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "_fwd") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 81; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  4: values[3] = PyTuple_GET_ITEM(__pyx_args, 3);
...
static PyObject *__pyx_pf_5_proj_4Proj_4_inv(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_inv");
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "_inv") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 142; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    } else {
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  4: values[3] = PyTuple_GET_ITEM(__pyx_args, 3);
...
static PyObject *__pyx_pf_5_proj_1_transform(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "_transform") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 298; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
 ...
 *     bytestr = _strencode(datapath)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5_proj_set_datapath, NULL, __pyx_n_s___proj); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 45; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
 ...
 *     cdef void *xdata, *ydata, *zdata
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5_proj_1_transform, NULL, __pyx_n_s___proj); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 298; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);

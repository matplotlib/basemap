 ...
 */
      __pyx_3 = __Pyx_GetName(__pyx_m, __pyx_n__rad2dg); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 131; __pyx_clineno = __LINE__; goto __pyx_L1;}
      __pyx_4 = PyFloat_FromDouble(__pyx_v_projlonlatout.v); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 131; __pyx_clineno = __LINE__; goto __pyx_L1;}
      __pyx_2 = PyNumber_Multiply(__pyx_3, __pyx_4); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 131; __pyx_clineno = __LINE__; goto __pyx_L1;}
      Py_DECREF(__pyx_3); __pyx_3 = 0;
      Py_DECREF(__pyx_4); __pyx_4 = 0;
      __pyx_6 = __pyx_PyFloat_AsDouble(__pyx_2); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 131; __pyx_clineno = __LINE__; goto __pyx_L1;}
      Py_DECREF(__pyx_2); __pyx_2 = 0;
...
/* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":133
 *                 ydatab[i] = _rad2dg*projlonlatout.v
 * 
 *     def _fwdn(self, c_numpy.ndarray lonlat, radians=False, errcheck=False):             # <<<<<<<<<<<<<< 
 *         """
...
static PyObject *__pyx_pf_5_proj_4Proj__fwdn(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (likely(!__pyx_kwds) && likely(1 <= PyTuple_GET_SIZE(__pyx_args)) && likely(PyTuple_GET_SIZE(__pyx_args) <= 3)) {
    ...
    if (unlikely(!PyArg_ParseTupleAndKeywords(__pyx_args, __pyx_kwds, "O|OO", __pyx_argnames, &__pyx_v_lonlat, &__pyx_v_radians, &__pyx_v_errcheck))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 133; __pyx_clineno = __LINE__; goto __pyx_L2;}
  }
  goto __pyx_L3;
  __pyx_L2:;
  ...
  return NULL;
  __pyx_L3:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_lonlat), __pyx_ptype_7c_numpy_ndarray, 1, "lonlat", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 133; __pyx_clineno = __LINE__; goto __pyx_L1;}
 ...
 */
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_v_npts; __pyx_v_i++) {
    ...
    /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":150
 *         llptr = <projUV *>lonlat.data
 *         for i from 0 <= i < npts:
 *             if radians:             # <<<<<<<<<<<<<< 
 *                 projlonlatin = llptr[i]
 *             else:
 */
    __pyx_1 = __Pyx_PyObject_IsTrue(__pyx_v_radians); if (unlikely(__pyx_1 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 150; __pyx_clineno = __LINE__; goto __pyx_L1;}
    if (__pyx_1) {
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":153
 *                 projlonlatin = llptr[i]
 *             else:
 *                 projlonlatin.u = _dg2rad*llptr[i].u             # <<<<<<<<<<<<<< 
 ...
 *             projxyout = pj_fwd(projlonlatin,self.projpj)
 */
      __pyx_2 = __Pyx_GetName(__pyx_m, __pyx_n__dg2rad); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 153; __pyx_clineno = __LINE__; goto __pyx_L1;}
      __pyx_3 = PyFloat_FromDouble((__pyx_v_llptr[__pyx_v_i]).u); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 153; __pyx_clineno = __LINE__; goto __pyx_L1;}
      __pyx_4 = PyNumber_Multiply(__pyx_2, __pyx_3); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 153; __pyx_clineno = __LINE__; goto __pyx_L1;}
      Py_DECREF(__pyx_2); __pyx_2 = 0;
      Py_DECREF(__pyx_3); __pyx_3 = 0;
      __pyx_5 = __pyx_PyFloat_AsDouble(__pyx_4); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 153; __pyx_clineno = __LINE__; goto __pyx_L1;}
      Py_DECREF(__pyx_4); __pyx_4 = 0;
      __pyx_v_projlonlatin.u = __pyx_5;

      /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":154
 *             else:
 *                 projlonlatin.u = _dg2rad*llptr[i].u
 *                 projlonlatin.v = _dg2rad*llptr[i].v             # <<<<<<<<<<<<<< 
 *             projxyout = pj_fwd(projlonlatin,self.projpj)
 * 
 */
      __pyx_2 = __Pyx_GetName(__pyx_m, __pyx_n__dg2rad); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 154; __pyx_clineno = __LINE__; goto __pyx_L1;}
      __pyx_3 = PyFloat_FromDouble((__pyx_v_llptr[__pyx_v_i]).v); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 154; __pyx_clineno = __LINE__; goto __pyx_L1;}
      __pyx_4 = PyNumber_Multiply(__pyx_2, __pyx_3); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 154; __pyx_clineno = __LINE__; goto __pyx_L1;}
      Py_DECREF(__pyx_2); __pyx_2 = 0;
      Py_DECREF(__pyx_3); __pyx_3 = 0;
      __pyx_5 = __pyx_PyFloat_AsDouble(__pyx_4); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 154; __pyx_clineno = __LINE__; goto __pyx_L1;}
      Py_DECREF(__pyx_4); __pyx_4 = 0;
 ...
 */
    ...
    /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":157
 *             projxyout = pj_fwd(projlonlatin,self.projpj)
 * 
 *             if errcheck and pj_errno != 0:             # <<<<<<<<<<<<<< 
 *                 raise RuntimeError(pj_strerrno(pj_errno))
 ...
 */
    __pyx_2 = __pyx_v_errcheck;
    Py_INCREF(__pyx_2);
    __pyx_1 = __Pyx_PyObject_IsTrue(__pyx_2); if (unlikely(__pyx_1 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1;}
    if (__pyx_1) {
      Py_DECREF(__pyx_2); __pyx_2 = 0;
      __pyx_2 = __Pyx_PyBool_FromLong((pj_errno != 0)); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1;}
    }
    __pyx_1 = __Pyx_PyObject_IsTrue(__pyx_2); if (unlikely(__pyx_1 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 157; __pyx_clineno = __LINE__; goto __pyx_L1;}
    Py_DECREF(__pyx_2); __pyx_2 = 0;
    if (__pyx_1) {
 ...
 *             # change it to a real (but very large) number.
 */
      __pyx_3 = PyString_FromString(pj_strerrno(pj_errno)); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 158; __pyx_clineno = __LINE__; goto __pyx_L1;}
      __pyx_4 = PyTuple_New(1); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 158; __pyx_clineno = __LINE__; goto __pyx_L1;}
      PyTuple_SET_ITEM(__pyx_4, 0, __pyx_3);
      __pyx_3 = 0;
      __pyx_2 = PyObject_Call(__pyx_builtin_RuntimeError, ((PyObject *)__pyx_4), NULL); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 158; __pyx_clineno = __LINE__; goto __pyx_L1;}
      Py_DECREF(((PyObject *)__pyx_4)); __pyx_4 = 0;
      __Pyx_Raise(__pyx_2, 0, 0);
      Py_DECREF(__pyx_2); __pyx_2 = 0;
    ...
    /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":161
 *             # since HUGE_VAL can be 'inf',
 *             # change it to a real (but very large) number.
 *             if projxyout.u == HUGE_VAL:             # <<<<<<<<<<<<<< 
 *                 llptr[i].u = 1.e30
 ...
 */
    ...
    /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":165
 *             else:
 *                 llptr[i].u = projxyout.u
 *             if projxyout.v == HUGE_VAL:             # <<<<<<<<<<<<<< 
 *                 llptr[i].u = 1.e30
 ...
 */
    ...
    if (__pyx_1) {
      ...
      /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":166
 *                 llptr[i].u = projxyout.u
 *             if projxyout.v == HUGE_VAL:
 *                 llptr[i].u = 1.e30             # <<<<<<<<<<<<<< 
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":168
 *                 llptr[i].u = 1.e30
 *             else:
 *                 llptr[i].v = projxyout.v             # <<<<<<<<<<<<<< 
 * 
...
/* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":170
 *                 llptr[i].v = projxyout.v
 * 
 *     def _invn(self, c_numpy.ndarray xy, radians=False, errcheck=False):             # <<<<<<<<<<<<<< 
 *         """
...
static PyObject *__pyx_pf_5_proj_4Proj__invn(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (likely(!__pyx_kwds) && likely(1 <= PyTuple_GET_SIZE(__pyx_args)) && likely(PyTuple_GET_SIZE(__pyx_args) <= 3)) {
    ...
    if (unlikely(!PyArg_ParseTupleAndKeywords(__pyx_args, __pyx_kwds, "O|OO", __pyx_argnames, &__pyx_v_xy, &__pyx_v_radians, &__pyx_v_errcheck))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 170; __pyx_clineno = __LINE__; goto __pyx_L2;}
  }
  goto __pyx_L3;
  __pyx_L2:;
  ...
  return NULL;
  __pyx_L3:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_xy), __pyx_ptype_7c_numpy_ndarray, 1, "xy", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 170; __pyx_clineno = __LINE__; goto __pyx_L1;}
 ...
 */
  ...
  /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":185
 *         llptr = <projUV *>xy.data
 * 
 *         for i from 0 <= i < npts:             # <<<<<<<<<<<<<< 
 *             projxyin = llptr[i]
 ...
 */
    ...
    if (__pyx_2) {
      Py_DECREF(__pyx_1); __pyx_1 = 0;
      __pyx_1 = __Pyx_PyBool_FromLong((pj_errno != 0)); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 188; __pyx_clineno = __LINE__; goto __pyx_L1;}
    }
    __pyx_2 = __Pyx_PyObject_IsTrue(__pyx_1); if (unlikely(__pyx_2 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 188; __pyx_clineno = __LINE__; goto __pyx_L1;}
    Py_DECREF(__pyx_1); __pyx_1 = 0;
    if (__pyx_2) {
 ...
 *             # change it to a real (but very large) number.
 */
      __pyx_1 = PyString_FromString(pj_strerrno(pj_errno)); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 189; __pyx_clineno = __LINE__; goto __pyx_L1;}
      __pyx_3 = PyTuple_New(1); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 189; __pyx_clineno = __LINE__; goto __pyx_L1;}
      PyTuple_SET_ITEM(__pyx_3, 0, __pyx_1);
      __pyx_1 = 0;
      __pyx_1 = PyObject_Call(__pyx_builtin_RuntimeError, ((PyObject *)__pyx_3), NULL); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 189; __pyx_clineno = __LINE__; goto __pyx_L1;}
      Py_DECREF(((PyObject *)__pyx_3)); __pyx_3 = 0;
 ...
 *                 llptr[i].v = 1.e30
 */
      __pyx_3 = __Pyx_GetName(__pyx_m, __pyx_n__rad2dg); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 197; __pyx_clineno = __LINE__; goto __pyx_L1;}
      __pyx_1 = PyFloat_FromDouble(__pyx_v_projlonlatout.u); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 197; __pyx_clineno = __LINE__; goto __pyx_L1;}
    ...
    /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":198
 *             else:
 *                 llptr[i].u = _rad2dg*projlonlatout.u
 *             if projlonlatout.v == HUGE_VAL:             # <<<<<<<<<<<<<< 
 *                 llptr[i].v = 1.e30
 ...
 */
    ...
    /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":200
 *             if projlonlatout.v == HUGE_VAL:
 *                 llptr[i].v = 1.e30
 *             elif radians:             # <<<<<<<<<<<<<< 
 *                 llptr[i].v = projlonlatout.v
 *             else:
 */
    __pyx_2 = __Pyx_PyObject_IsTrue(__pyx_v_radians); if (unlikely(__pyx_2 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 200; __pyx_clineno = __LINE__; goto __pyx_L1;}
    if (__pyx_2) {

      /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":201
 *                 llptr[i].v = 1.e30
 *             elif radians:
 *                 llptr[i].v = projlonlatout.v             # <<<<<<<<<<<<<< 
 *             else:
 ...
 *     def is_latlong(self):
 */
      __pyx_3 = __Pyx_GetName(__pyx_m, __pyx_n__rad2dg); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 203; __pyx_clineno = __LINE__; goto __pyx_L1;}
      __pyx_1 = PyFloat_FromDouble(__pyx_v_projlonlatout.v); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 203; __pyx_clineno = __LINE__; goto __pyx_L1;}
      __pyx_4 = PyNumber_Multiply(__pyx_3, __pyx_1); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 203; __pyx_clineno = __LINE__; goto __pyx_L1;}
      Py_DECREF(__pyx_3); __pyx_3 = 0;
      Py_DECREF(__pyx_1); __pyx_1 = 0;
      __pyx_5 = __pyx_PyFloat_AsDouble(__pyx_4); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 203; __pyx_clineno = __LINE__; goto __pyx_L1;}
      Py_DECREF(__pyx_4); __pyx_4 = 0;
...
/* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":205
 *                 llptr[i].v = _rad2dg*projlonlatout.v
 *  
 *     def is_latlong(self):             # <<<<<<<<<<<<<< 
 ...
 */
  ...
  /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":209
 *         cdef int i
 *         i = pj_is_latlong(self.projpj)
 *         if i:             # <<<<<<<<<<<<<< 
 *             return True
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":210
 *         i = pj_is_latlong(self.projpj)
 *         if i:
 *             return True             # <<<<<<<<<<<<<< 
 *         else:
...
/* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":214
 *             return False
 * 
 *     def is_geocent(self):             # <<<<<<<<<<<<<< 
 ...
 */
  ...
  /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":218
 *         cdef int i
 *         i = pj_is_geocent(self.projpj)
 *         if i:             # <<<<<<<<<<<<<< 
 *             return True
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":219
 *         i = pj_is_geocent(self.projpj)
 *         if i:
 *             return True             # <<<<<<<<<<<<<< 
 *         else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":221
 *             return True
 *         else:
 *             return False             # <<<<<<<<<<<<<< 
 * 
...
static char __pyx_k_10[] = "x,y and z must be same size";
...
static PyObject *__pyx_pf_5_proj__transform(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  if (likely(!__pyx_kwds) && likely(PyTuple_GET_SIZE(__pyx_args) == 6)) {
    ...
    if (unlikely(!PyArg_ParseTupleAndKeywords(__pyx_args, __pyx_kwds, "OOOOOO", __pyx_argnames, &__pyx_v_p1, &__pyx_v_p2, &__pyx_v_inx, &__pyx_v_iny, &__pyx_v_inz, &__pyx_v_radians))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 223; __pyx_clineno = __LINE__; goto __pyx_L2;}
  }
  goto __pyx_L3;
  __pyx_L2:;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_p1), __pyx_ptype_5_proj_Proj, 1, "p1", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 223; __pyx_clineno = __LINE__; goto __pyx_L1;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_p2), __pyx_ptype_5_proj_Proj, 1, "p2", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 223; __pyx_clineno = __LINE__; goto __pyx_L1;}
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":229
 *     cdef Py_ssize_t buflenx, bufleny, buflenz, npts, i
 *     if PyObject_AsWriteBuffer(inx, &xdata, &buflenx) <> 0:
 *         raise RuntimeError             # <<<<<<<<<<<<<< 
 *     if PyObject_AsWriteBuffer(iny, &ydata, &bufleny) <> 0:
 ...
 */
    ...
    PyTuple_SET_ITEM(__pyx_3, 0, __pyx_k_10p);
    __pyx_4 = PyObject_Call(__pyx_builtin_RuntimeError, ((PyObject *)__pyx_3), NULL); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 238; __pyx_clineno = __LINE__; goto __pyx_L1;}
    Py_DECREF(((PyObject *)__pyx_3)); __pyx_3 = 0;
 ...
 */
  ...
  /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":244
 *         zz = <double *>zdata
 *     npts = buflenx/8
 *     if not radians and p1.is_latlong():             # <<<<<<<<<<<<<< 
 *         for i from 0 <= i < npts:
 *             xx[i] = xx[i]*_dg2rad
 */
  __pyx_2 = __Pyx_PyObject_IsTrue(__pyx_v_radians); if (unlikely(__pyx_2 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 244; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_3 = __Pyx_PyBool_FromLong((!__pyx_2)); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 244; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_1 = __Pyx_PyObject_IsTrue(__pyx_3); if (unlikely(__pyx_1 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 244; __pyx_clineno = __LINE__; goto __pyx_L1;}
  if (__pyx_1) {
    Py_DECREF(__pyx_3); __pyx_3 = 0;
    __pyx_4 = PyObject_GetAttr(((PyObject *)__pyx_v_p1), __pyx_n_is_latlong); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 244; __pyx_clineno = __LINE__; goto __pyx_L1;}
    __pyx_3 = PyObject_Call(__pyx_4, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 244; __pyx_clineno = __LINE__; goto __pyx_L1;}
    Py_DECREF(__pyx_4); __pyx_4 = 0;
  }
  __pyx_2 = __Pyx_PyObject_IsTrue(__pyx_3); if (unlikely(__pyx_2 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 244; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  if (__pyx_2) {
 ...
 *     if inz is not None:
 */
      __pyx_4 = PyFloat_FromDouble((__pyx_v_xx[__pyx_v_i])); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 246; __pyx_clineno = __LINE__; goto __pyx_L1;}
      __pyx_3 = __Pyx_GetName(__pyx_m, __pyx_n__dg2rad); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 246; __pyx_clineno = __LINE__; goto __pyx_L1;}
      __pyx_5 = PyNumber_Multiply(__pyx_4, __pyx_3); if (unlikely(!__pyx_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 246; __pyx_clineno = __LINE__; goto __pyx_L1;}
      Py_DECREF(__pyx_4); __pyx_4 = 0;
      Py_DECREF(__pyx_3); __pyx_3 = 0;
      __pyx_6 = __pyx_PyFloat_AsDouble(__pyx_5); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 246; __pyx_clineno = __LINE__; goto __pyx_L1;}
      Py_DECREF(__pyx_5); __pyx_5 = 0;
 ...
 */
      __pyx_4 = PyFloat_FromDouble((__pyx_v_yy[__pyx_v_i])); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 247; __pyx_clineno = __LINE__; goto __pyx_L1;}
      __pyx_3 = __Pyx_GetName(__pyx_m, __pyx_n__dg2rad); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 247; __pyx_clineno = __LINE__; goto __pyx_L1;}
      __pyx_5 = PyNumber_Multiply(__pyx_4, __pyx_3); if (unlikely(!__pyx_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 247; __pyx_clineno = __LINE__; goto __pyx_L1;}
      Py_DECREF(__pyx_4); __pyx_4 = 0;
      Py_DECREF(__pyx_3); __pyx_3 = 0;
      __pyx_6 = __pyx_PyFloat_AsDouble(__pyx_5); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 247; __pyx_clineno = __LINE__; goto __pyx_L1;}
      Py_DECREF(__pyx_5); __pyx_5 = 0;
 ...
 */
    __pyx_4 = PyInt_FromLong(pj_transform(__pyx_v_p1->projpj, __pyx_v_p2->projpj, __pyx_v_npts, 0, __pyx_v_xx, __pyx_v_yy, __pyx_v_zz)); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 249; __pyx_clineno = __LINE__; goto __pyx_L1;}
 ...
 */
    __pyx_3 = PyInt_FromLong(pj_transform(__pyx_v_p1->projpj, __pyx_v_p2->projpj, __pyx_v_npts, 0, __pyx_v_xx, __pyx_v_yy, NULL)); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 251; __pyx_clineno = __LINE__; goto __pyx_L1;}
    Py_DECREF(__pyx_v_ierr);
  ...
  /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":252
 *     else:
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, NULL)
 *     if ierr != 0:             # <<<<<<<<<<<<<< 
 *         raise RuntimeError(pj_strerrno(ierr))
 ...
 */
  __pyx_5 = PyObject_RichCompare(__pyx_v_ierr, __pyx_int_0, Py_NE); if (unlikely(!__pyx_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 252; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_2 = __Pyx_PyObject_IsTrue(__pyx_5); if (unlikely(__pyx_2 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 252; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(__pyx_5); __pyx_5 = 0;
  if (__pyx_2) {

    /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":253
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, NULL)
 *     if ierr != 0:
 *         raise RuntimeError(pj_strerrno(ierr))             # <<<<<<<<<<<<<< 
 *     if not radians and p2.is_latlong():
 *         for i from 0 <= i < npts:
 */
    __pyx_7 = __pyx_PyInt_int(__pyx_v_ierr); if (unlikely((__pyx_7 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 253; __pyx_clineno = __LINE__; goto __pyx_L1;}
    __pyx_4 = PyString_FromString(pj_strerrno(__pyx_7)); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 253; __pyx_clineno = __LINE__; goto __pyx_L1;}
    __pyx_3 = PyTuple_New(1); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 253; __pyx_clineno = __LINE__; goto __pyx_L1;}
    PyTuple_SET_ITEM(__pyx_3, 0, __pyx_4);
    __pyx_4 = 0;
    __pyx_5 = PyObject_Call(__pyx_builtin_RuntimeError, ((PyObject *)__pyx_3), NULL); if (unlikely(!__pyx_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 253; __pyx_clineno = __LINE__; goto __pyx_L1;}
    Py_DECREF(((PyObject *)__pyx_3)); __pyx_3 = 0;
  ...
  /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":254
 *     if ierr != 0:
 *         raise RuntimeError(pj_strerrno(ierr))
 *     if not radians and p2.is_latlong():             # <<<<<<<<<<<<<< 
 *         for i from 0 <= i < npts:
 *             xx[i] = xx[i]*_rad2dg
 */
  __pyx_1 = __Pyx_PyObject_IsTrue(__pyx_v_radians); if (unlikely(__pyx_1 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 254; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_4 = __Pyx_PyBool_FromLong((!__pyx_1)); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 254; __pyx_clineno = __LINE__; goto __pyx_L1;}
  __pyx_2 = __Pyx_PyObject_IsTrue(__pyx_4); if (unlikely(__pyx_2 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 254; __pyx_clineno = __LINE__; goto __pyx_L1;}
  if (__pyx_2) {
    Py_DECREF(__pyx_4); __pyx_4 = 0;
    __pyx_3 = PyObject_GetAttr(((PyObject *)__pyx_v_p2), __pyx_n_is_latlong); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 254; __pyx_clineno = __LINE__; goto __pyx_L1;}
    __pyx_4 = PyObject_Call(__pyx_3, ((PyObject *)__pyx_empty_tuple), NULL); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 254; __pyx_clineno = __LINE__; goto __pyx_L1;}
    Py_DECREF(__pyx_3); __pyx_3 = 0;
  }
  __pyx_1 = __Pyx_PyObject_IsTrue(__pyx_4); if (unlikely(__pyx_1 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 254; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  if (__pyx_1) {

    /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":255
 *         raise RuntimeError(pj_strerrno(ierr))
 *     if not radians and p2.is_latlong():
 *         for i from 0 <= i < npts:             # <<<<<<<<<<<<<< 
 *             xx[i] = xx[i]*_rad2dg
 ...
 */
    for (__pyx_v_i = 0; __pyx_v_i < __pyx_v_npts; __pyx_v_i++) {
      ...
      /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":256
 *     if not radians and p2.is_latlong():
 *         for i from 0 <= i < npts:
 *             xx[i] = xx[i]*_rad2dg             # <<<<<<<<<<<<<< 
 *             yy[i] = yy[i]*_rad2dg
 */
      __pyx_5 = PyFloat_FromDouble((__pyx_v_xx[__pyx_v_i])); if (unlikely(!__pyx_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 256; __pyx_clineno = __LINE__; goto __pyx_L1;}
      __pyx_3 = __Pyx_GetName(__pyx_m, __pyx_n__rad2dg); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 256; __pyx_clineno = __LINE__; goto __pyx_L1;}
      __pyx_4 = PyNumber_Multiply(__pyx_5, __pyx_3); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 256; __pyx_clineno = __LINE__; goto __pyx_L1;}
      Py_DECREF(__pyx_5); __pyx_5 = 0;
      Py_DECREF(__pyx_3); __pyx_3 = 0;
      __pyx_6 = __pyx_PyFloat_AsDouble(__pyx_4); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 256; __pyx_clineno = __LINE__; goto __pyx_L1;}
      Py_DECREF(__pyx_4); __pyx_4 = 0;
      (__pyx_v_xx[__pyx_v_i]) = __pyx_6;

      /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":257
 *         for i from 0 <= i < npts:
 *             xx[i] = xx[i]*_rad2dg
 *             yy[i] = yy[i]*_rad2dg             # <<<<<<<<<<<<<< 
 */
      __pyx_5 = PyFloat_FromDouble((__pyx_v_yy[__pyx_v_i])); if (unlikely(!__pyx_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 257; __pyx_clineno = __LINE__; goto __pyx_L1;}
      __pyx_3 = __Pyx_GetName(__pyx_m, __pyx_n__rad2dg); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 257; __pyx_clineno = __LINE__; goto __pyx_L1;}
      __pyx_4 = PyNumber_Multiply(__pyx_5, __pyx_3); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 257; __pyx_clineno = __LINE__; goto __pyx_L1;}
      Py_DECREF(__pyx_5); __pyx_5 = 0;
      Py_DECREF(__pyx_3); __pyx_3 = 0;
      __pyx_6 = __pyx_PyFloat_AsDouble(__pyx_4); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 257; __pyx_clineno = __LINE__; goto __pyx_L1;}
      Py_DECREF(__pyx_4); __pyx_4 = 0;
      (__pyx_v_yy[__pyx_v_i]) = __pyx_6;
    }
    goto __pyx_L15;
...
PyMODINIT_FUNC init_proj(void) {
  ...
  /*--- Builtin init code ---*/
  __pyx_builtin_RuntimeError = __Pyx_GetName(__pyx_b, __pyx_n_RuntimeError); if (!__pyx_builtin_RuntimeError) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 31; __pyx_clineno = __LINE__; goto __pyx_L1;}
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_5_proj_Proj) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1;}
  if (PyObject_SetAttrString(__pyx_m, "Proj", (PyObject *)&__pyx_type_5_proj_Proj) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1;}
 ...
 * 
 */
  __pyx_2 = __Pyx_Import(__pyx_n_numpy, 0); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1;}
  if (PyObject_SetAttr(__pyx_m, __pyx_n_numpy, __pyx_2) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; __pyx_clineno = __LINE__; goto __pyx_L1;}
  Py_DECREF(__pyx_2); __pyx_2 = 0;

  /* "/Volumes/User/jwhitaker/matplotlib/basemap/src/_proj.pyx":6
 * cimport c_numpy
 * import numpy
 * c_numpy.import_array()             # <<<<<<<<<<<<<< 
 * 

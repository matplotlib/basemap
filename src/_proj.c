...
static PyObject *__pyx_f_py_5_proj_set_datapath(PyObject *__pyx_self, PyObject *__pyx_v_datapath) {
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":7
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":8
 *     cdef char *searchpath
 *     searchpath = PyString_AsString(datapath)
 *     pj_set_searchpath(1, &searchpath)             # <<<<<<<<<<<<<< 
 *     
...
static int __pyx_f_py_5_proj_4Proj___new__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":18
 * 
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":20
 *         self.projparams = projparams
 *         # setup proj initialization string.
 *         pjargs = []             # <<<<<<<<<<<<<< 
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":21
 *         # setup proj initialization string.
 *         pjargs = []
 *         for key,value in projparams.iteritems():             # <<<<<<<<<<<<<< 
 *             pjargs.append('+'+key+"="+str(value)+' ')
 ...
 */
  ...
  for (;;) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":22
 *         pjargs = []
 *         for key,value in projparams.iteritems():
 *             pjargs.append('+'+key+"="+str(value)+' ')             # <<<<<<<<<<<<<< 
 *         self.srs = ''.join(pjargs)
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":23
 *         for key,value in projparams.iteritems():
 *             pjargs.append('+'+key+"="+str(value)+' ')
 *         self.srs = ''.join(pjargs)             # <<<<<<<<<<<<<< 
 *         self.pjinitstring = PyString_AsString(self.srs)
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":24
 *             pjargs.append('+'+key+"="+str(value)+' ')
 *         self.srs = ''.join(pjargs)
 *         self.pjinitstring = PyString_AsString(self.srs)             # <<<<<<<<<<<<<< 
 *         # initialize projection
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":26
 *         self.pjinitstring = PyString_AsString(self.srs)
 *         # initialize projection
 *         self.projpj = pj_init_plus(self.pjinitstring)             # <<<<<<<<<<<<<< 
 *         if pj_errno != 0:
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":27
 *         # initialize projection
 *         self.projpj = pj_init_plus(self.pjinitstring)
 *         if pj_errno != 0:             # <<<<<<<<<<<<<< 
 *             raise RuntimeError(pj_strerrno(pj_errno))
 ...
 */
  ...
  if (__pyx_7) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":28
 *         self.projpj = pj_init_plus(self.pjinitstring)
 *         if pj_errno != 0:
 *             raise RuntimeError(pj_strerrno(pj_errno))             # <<<<<<<<<<<<<< 
 *         self.proj_version = PJ_VERSION/100.
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":29
 *         if pj_errno != 0:
 *             raise RuntimeError(pj_strerrno(pj_errno))
 *         self.proj_version = PJ_VERSION/100.             # <<<<<<<<<<<<<< 
 * 
...
static void __pyx_f_py_5_proj_4Proj___dealloc__(PyObject *__pyx_v_self) {
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":33
 *     def __dealloc__(self):
...
static PyObject *__pyx_f_py_5_proj_4Proj___reduce__(PyObject *__pyx_v_self, PyObject *unused) {
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":37
 *     def __reduce__(self):
...
static PyObject *__pyx_f_py_5_proj_4Proj__fwd(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":53
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":54
 *         # if buffer api is supported, get pointer to data buffers.
 *         if PyObject_AsWriteBuffer(lons, &londata, &buflenx) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<< 
 *         if PyObject_AsWriteBuffer(lats, &latdata, &bufleny) <> 0:
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":55
 *         if PyObject_AsWriteBuffer(lons, &londata, &buflenx) <> 0:
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(lats, &latdata, &bufleny) <> 0:             # <<<<<<<<<<<<<< 
 *             raise RuntimeError
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":56
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(lats, &latdata, &bufleny) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<< 
 *         # process data in buffer
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":58
 *             raise RuntimeError
 *         # process data in buffer
 *         if buflenx != bufleny:             # <<<<<<<<<<<<<< 
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":59
 *         # process data in buffer
 *         if buflenx != bufleny:
 *             raise RuntimeError("Buffer lengths not the same")             # <<<<<<<<<<<<<< 
 *         ndim = buflenx/_doublesize
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":60
 *         if buflenx != bufleny:
 *             raise RuntimeError("Buffer lengths not the same")
 *         ndim = buflenx/_doublesize             # <<<<<<<<<<<<<< 
 *         lonsdata = <double *>londata
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":61
 *             raise RuntimeError("Buffer lengths not the same")
 *         ndim = buflenx/_doublesize
 *         lonsdata = <double *>londata             # <<<<<<<<<<<<<< 
 *         latsdata = <double *>latdata
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":62
 *         ndim = buflenx/_doublesize
 *         lonsdata = <double *>londata
 *         latsdata = <double *>latdata             # <<<<<<<<<<<<<< 
 *         for i from 0 <= i < ndim:
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":63
 *         lonsdata = <double *>londata
 *         latsdata = <double *>latdata
 *         for i from 0 <= i < ndim:             # <<<<<<<<<<<<<< 
 *             if radians:
 ...
 */
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_v_ndim; __pyx_v_i++) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":64
 *         latsdata = <double *>latdata
 *         for i from 0 <= i < ndim:
 *             if radians:             # <<<<<<<<<<<<<< 
 *                 projlonlatin.u = lonsdata[i]
 ...
 */
    ...
    if (__pyx_1) {
      ...
      /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":65
 *         for i from 0 <= i < ndim:
 *             if radians:
 *                 projlonlatin.u = lonsdata[i]             # <<<<<<<<<<<<<< 
 *                 projlonlatin.v = latsdata[i]
 ...
 */
      ...
      /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":66
 *             if radians:
 *                 projlonlatin.u = lonsdata[i]
 *                 projlonlatin.v = latsdata[i]             # <<<<<<<<<<<<<< 
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":68
 *                 projlonlatin.v = latsdata[i]
 *             else:
 *                 projlonlatin.u = _dg2rad*lonsdata[i]             # <<<<<<<<<<<<<< 
 ...
 */
      ...
      /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":69
 *             else:
 *                 projlonlatin.u = _dg2rad*lonsdata[i]
 *                 projlonlatin.v = _dg2rad*latsdata[i]             # <<<<<<<<<<<<<< 
 *             projxyout = pj_fwd(projlonlatin,self.projpj)
 ...
 */
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":70
 *                 projlonlatin.u = _dg2rad*lonsdata[i]
 *                 projlonlatin.v = _dg2rad*latsdata[i]
 *             projxyout = pj_fwd(projlonlatin,self.projpj)             # <<<<<<<<<<<<<< 
 *             if errcheck and pj_errno != 0:
 ...
 */
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":71
 *                 projlonlatin.v = _dg2rad*latsdata[i]
 *             projxyout = pj_fwd(projlonlatin,self.projpj)
 *             if errcheck and pj_errno != 0:             # <<<<<<<<<<<<<< 
 *                 raise RuntimeError(pj_strerrno(pj_errno))
 ...
 */
    ...
    if (__pyx_1) {
      ...
      /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":72
 *             projxyout = pj_fwd(projlonlatin,self.projpj)
 *             if errcheck and pj_errno != 0:
 *                 raise RuntimeError(pj_strerrno(pj_errno))             # <<<<<<<<<<<<<< 
 *             # since HUGE_VAL can be 'inf',
 ...
 */
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":75
 *             # since HUGE_VAL can be 'inf',
 *             # change it to a real (but very large) number.
 ...
 */
    ...
    if (__pyx_1) {
      ...
      /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":76
 *             # change it to a real (but very large) number.
 *             if projxyout.u == HUGE_VAL:
 *                 lonsdata[i] = 1.e30             # <<<<<<<<<<<<<< 
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":78
 *                 lonsdata[i] = 1.e30
 *             else:
 *                 lonsdata[i] = projxyout.u             # <<<<<<<<<<<<<< 
 ...
 */
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":79
 *             else:
 *                 lonsdata[i] = projxyout.u
 *             if projxyout.v == HUGE_VAL:             # <<<<<<<<<<<<<< 
 *                 latsdata[i] = 1.e30
 ...
 */
    ...
    if (__pyx_1) {
      ...
      /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":80
 *                 lonsdata[i] = projxyout.u
 *             if projxyout.v == HUGE_VAL:
 *                 latsdata[i] = 1.e30             # <<<<<<<<<<<<<< 
 *             else:     
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":82
 *                 latsdata[i] = 1.e30
 *             else:     
 *                 latsdata[i] = projxyout.v             # <<<<<<<<<<<<<< 
 * 
...
static PyObject *__pyx_f_py_5_proj_4Proj__inv(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":98
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":99
 *         # if buffer api is supported, get pointer to data buffers.
 *         if PyObject_AsWriteBuffer(x, &xdata, &buflenx) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<< 
 *         if PyObject_AsWriteBuffer(y, &ydata, &bufleny) <> 0:
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":100
 *         if PyObject_AsWriteBuffer(x, &xdata, &buflenx) <> 0:
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(y, &ydata, &bufleny) <> 0:             # <<<<<<<<<<<<<< 
 *             raise RuntimeError
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":101
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(y, &ydata, &bufleny) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<< 
 *         # process data in buffer 
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":104
 *         # process data in buffer 
 *         # (for numpy/regular python arrays).
 *         if buflenx != bufleny:             # <<<<<<<<<<<<<< 
 *             raise RuntimeError("Buffer lengths not the same")
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":105
 *         # (for numpy/regular python arrays).
 *         if buflenx != bufleny:
 *             raise RuntimeError("Buffer lengths not the same")             # <<<<<<<<<<<<<< 
 *         ndim = buflenx/_doublesize
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":106
 *         if buflenx != bufleny:
 *             raise RuntimeError("Buffer lengths not the same")
 *         ndim = buflenx/_doublesize             # <<<<<<<<<<<<<< 
 *         xdatab = <double *>xdata
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":107
 *             raise RuntimeError("Buffer lengths not the same")
 *         ndim = buflenx/_doublesize
 *         xdatab = <double *>xdata             # <<<<<<<<<<<<<< 
 *         ydatab = <double *>ydata
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":108
 *         ndim = buflenx/_doublesize
 *         xdatab = <double *>xdata
 *         ydatab = <double *>ydata             # <<<<<<<<<<<<<< 
 *         for i from 0 <= i < ndim:
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":109
 *         xdatab = <double *>xdata
 *         ydatab = <double *>ydata
 *         for i from 0 <= i < ndim:             # <<<<<<<<<<<<<< 
 *             projxyin.u = xdatab[i]
 ...
 */
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_v_ndim; __pyx_v_i++) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":110
 *         ydatab = <double *>ydata
 *         for i from 0 <= i < ndim:
 *             projxyin.u = xdatab[i]             # <<<<<<<<<<<<<< 
 *             projxyin.v = ydatab[i]
 ...
 */
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":111
 *         for i from 0 <= i < ndim:
 *             projxyin.u = xdatab[i]
 *             projxyin.v = ydatab[i]             # <<<<<<<<<<<<<< 
 *             projlonlatout = pj_inv(projxyin,self.projpj)
 ...
 */
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":112
 *             projxyin.u = xdatab[i]
 *             projxyin.v = ydatab[i]
 *             projlonlatout = pj_inv(projxyin,self.projpj)             # <<<<<<<<<<<<<< 
 *             if errcheck and pj_errno != 0:
 ...
 */
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":113
 *             projxyin.v = ydatab[i]
 *             projlonlatout = pj_inv(projxyin,self.projpj)
 *             if errcheck and pj_errno != 0:             # <<<<<<<<<<<<<< 
 *                 raise RuntimeError(pj_strerrno(pj_errno))
 ...
 */
    ...
    if (__pyx_1) {
      ...
      /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":114
 *             projlonlatout = pj_inv(projxyin,self.projpj)
 *             if errcheck and pj_errno != 0:
 *                 raise RuntimeError(pj_strerrno(pj_errno))             # <<<<<<<<<<<<<< 
 *             # since HUGE_VAL can be 'inf',
 ...
 */
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":117
 *             # since HUGE_VAL can be 'inf',
 *             # change it to a real (but very large) number.
 ...
 */
    ...
    if (__pyx_1) {
      ...
      /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":118
 *             # change it to a real (but very large) number.
 *             if projlonlatout.u == HUGE_VAL:
 *                 xdatab[i] = 1.e30             # <<<<<<<<<<<<<< 
 *             elif radians:
 ...
 */
    ...
    if (__pyx_1) {
      ...
      /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":120
 *                 xdatab[i] = 1.e30
 *             elif radians:
 *                 xdatab[i] = projlonlatout.u             # <<<<<<<<<<<<<< 
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":122
 *                 xdatab[i] = projlonlatout.u
 *             else:
 *                 xdatab[i] = _rad2dg*projlonlatout.u             # <<<<<<<<<<<<<< 
 ...
 */
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":123
 *             else:
 *                 xdatab[i] = _rad2dg*projlonlatout.u
 *             if projlonlatout.v == HUGE_VAL:             # <<<<<<<<<<<<<< 
 *                 ydatab[i] = 1.e30
 ...
 */
    ...
    if (__pyx_1) {
      ...
      /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":124
 *                 xdatab[i] = _rad2dg*projlonlatout.u
 *             if projlonlatout.v == HUGE_VAL:
 *                 ydatab[i] = 1.e30             # <<<<<<<<<<<<<< 
 *             elif radians:
 ...
 */
    ...
    if (__pyx_1) {
      ...
      /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":126
 *                 ydatab[i] = 1.e30
 *             elif radians:
 *                 ydatab[i] = projlonlatout.v             # <<<<<<<<<<<<<< 
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":128
 *                 ydatab[i] = projlonlatout.v
 *             else:
 *                 ydatab[i] = _rad2dg*projlonlatout.v             # <<<<<<<<<<<<<< 
 * 
...
static PyObject *__pyx_f_py_5_proj_4Proj_is_latlong(PyObject *__pyx_v_self, PyObject *unused) {
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":133
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":134
 *         cdef int i
 *         i = pj_is_latlong(self.projpj)
 *         if i:             # <<<<<<<<<<<<<< 
 *             return True
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":135
 *         i = pj_is_latlong(self.projpj)
 *         if i:
 *             return True             # <<<<<<<<<<<<<< 
 *         else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":137
 *             return True
 *         else:
 *             return False             # <<<<<<<<<<<<<< 
 * 
...
static PyObject *__pyx_f_py_5_proj_4Proj_is_geocent(PyObject *__pyx_v_self, PyObject *unused) {
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":142
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":143
 *         cdef int i
 *         i = pj_is_geocent(self.projpj)
 *         if i:             # <<<<<<<<<<<<<< 
 *             return True
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":144
 *         i = pj_is_geocent(self.projpj)
 *         if i:
 *             return True             # <<<<<<<<<<<<<< 
 *         else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":146
 *             return True
 *         else:
 *             return False             # <<<<<<<<<<<<<< 
 * 
...
static PyObject *__pyx_f_py_5_proj__transform(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":153
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":154
 *     cdef Py_ssize_t buflenx, bufleny, buflenz, npts, i
 *     if PyObject_AsWriteBuffer(inx, &xdata, &buflenx) <> 0:
 *         raise RuntimeError             # <<<<<<<<<<<<<< 
 *     if PyObject_AsWriteBuffer(iny, &ydata, &bufleny) <> 0:
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":155
 *     if PyObject_AsWriteBuffer(inx, &xdata, &buflenx) <> 0:
 *         raise RuntimeError
 *     if PyObject_AsWriteBuffer(iny, &ydata, &bufleny) <> 0:             # <<<<<<<<<<<<<< 
 *         raise RuntimeError
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":156
 *         raise RuntimeError
 *     if PyObject_AsWriteBuffer(iny, &ydata, &bufleny) <> 0:
 *         raise RuntimeError             # <<<<<<<<<<<<<< 
 *     if inz is not None:
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":157
 *     if PyObject_AsWriteBuffer(iny, &ydata, &bufleny) <> 0:
 *         raise RuntimeError
 *     if inz is not None:             # <<<<<<<<<<<<<< 
 *         if PyObject_AsWriteBuffer(inz, &zdata, &buflenz) <> 0:
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":158
 *         raise RuntimeError
 *     if inz is not None:
 *         if PyObject_AsWriteBuffer(inz, &zdata, &buflenz) <> 0:             # <<<<<<<<<<<<<< 
 *             raise RuntimeError
 ...
 */
    ...
    if (__pyx_1) {
      ...
      /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":159
 *     if inz is not None:
 *         if PyObject_AsWriteBuffer(inz, &zdata, &buflenz) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<< 
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":161
 *             raise RuntimeError
 *     else:
 *         buflenz = bufleny             # <<<<<<<<<<<<<< 
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":162
 *     else:
 *         buflenz = bufleny
 *     if not (buflenx == bufleny == buflenz):             # <<<<<<<<<<<<<< 
 *         raise RuntimeError('x,y and z must be same size')
 ...
 */
  ...
  if (__pyx_2) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":163
 *         buflenz = bufleny
 *     if not (buflenx == bufleny == buflenz):
 *         raise RuntimeError('x,y and z must be same size')             # <<<<<<<<<<<<<< 
 *     xx = <double *>xdata
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":164
 *     if not (buflenx == bufleny == buflenz):
 *         raise RuntimeError('x,y and z must be same size')
 *     xx = <double *>xdata             # <<<<<<<<<<<<<< 
 *     yy = <double *>ydata
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":165
 *         raise RuntimeError('x,y and z must be same size')
 *     xx = <double *>xdata
 *     yy = <double *>ydata             # <<<<<<<<<<<<<< 
 *     if inz is not None:
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":166
 *     xx = <double *>xdata
 *     yy = <double *>ydata
 *     if inz is not None:             # <<<<<<<<<<<<<< 
 *         zz = <double *>zdata
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":167
 *     yy = <double *>ydata
 *     if inz is not None:
 *         zz = <double *>zdata             # <<<<<<<<<<<<<< 
 *     npts = buflenx/8
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":168
 *     if inz is not None:
 *         zz = <double *>zdata
 *     npts = buflenx/8             # <<<<<<<<<<<<<< 
 *     if not radians and p1.is_latlong():
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":169
 *         zz = <double *>zdata
 *     npts = buflenx/8
 *     if not radians and p1.is_latlong():             # <<<<<<<<<<<<<< 
 *         for i from 0 <= i < npts:
 ...
 */
  ...
  if (__pyx_2) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":170
 *     npts = buflenx/8
 *     if not radians and p1.is_latlong():
 *         for i from 0 <= i < npts:             # <<<<<<<<<<<<<< 
 *             xx[i] = xx[i]*_dg2rad
 ...
 */
    for (__pyx_v_i = 0; __pyx_v_i < __pyx_v_npts; __pyx_v_i++) {
      ...
      /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":171
 *     if not radians and p1.is_latlong():
 *         for i from 0 <= i < npts:
 *             xx[i] = xx[i]*_dg2rad             # <<<<<<<<<<<<<< 
 *             yy[i] = yy[i]*_dg2rad
 ...
 */
      ...
      /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":172
 *         for i from 0 <= i < npts:
 *             xx[i] = xx[i]*_dg2rad
 *             yy[i] = yy[i]*_dg2rad             # <<<<<<<<<<<<<< 
 *     if inz is not None:
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":173
 *             xx[i] = xx[i]*_dg2rad
 *             yy[i] = yy[i]*_dg2rad
 *     if inz is not None:             # <<<<<<<<<<<<<< 
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, zz)
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":174
 *             yy[i] = yy[i]*_dg2rad
 *     if inz is not None:
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, zz)             # <<<<<<<<<<<<<< 
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":176
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, zz)
 *     else:
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, NULL)             # <<<<<<<<<<<<<< 
 *     if ierr != 0:
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":177
 *     else:
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, NULL)
 *     if ierr != 0:             # <<<<<<<<<<<<<< 
 *         raise RuntimeError(pj_strerrno(ierr))
 ...
 */
  ...
  if (__pyx_2) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":178
 *         ierr = pj_transform(p1.projpj, p2.projpj, npts, 0, xx, yy, NULL)
 *     if ierr != 0:
 *         raise RuntimeError(pj_strerrno(ierr))             # <<<<<<<<<<<<<< 
 *     if not radians and p2.is_latlong():
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":179
 *     if ierr != 0:
 *         raise RuntimeError(pj_strerrno(ierr))
 *     if not radians and p2.is_latlong():             # <<<<<<<<<<<<<< 
 *         for i from 0 <= i < npts:
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":180
 *         raise RuntimeError(pj_strerrno(ierr))
 *     if not radians and p2.is_latlong():
 *         for i from 0 <= i < npts:             # <<<<<<<<<<<<<< 
 *             xx[i] = xx[i]*_rad2dg
 ...
 */
    for (__pyx_v_i = 0; __pyx_v_i < __pyx_v_npts; __pyx_v_i++) {
      ...
      /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":181
 *     if not radians and p2.is_latlong():
 *         for i from 0 <= i < npts:
 *             xx[i] = xx[i]*_rad2dg             # <<<<<<<<<<<<<< 
 *             yy[i] = yy[i]*_rad2dg
 */
      ...
      /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":182
 *         for i from 0 <= i < npts:
 *             xx[i] = xx[i]*_rad2dg
 *             yy[i] = yy[i]*_rad2dg             # <<<<<<<<<<<<<< 
 */
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":39
 *         return (self.__class__,(self.projparams,))
 * 
 *     def _fwd(self, object lons, object lats, radians=False, errcheck=False):             # <<<<<<<<<<<<<< 
 *         """
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":84
 *                 latsdata[i] = projxyout.v
 * 
 *     def _inv(self, object x, object y, radians=False, errcheck=False):             # <<<<<<<<<<<<<< 
 *         """
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap/src/_proj.pyx":148
 *             return False
 * 
 * def _transform(Proj p1, Proj p2, inx, iny, inz, radians):             # <<<<<<<<<<<<<< 

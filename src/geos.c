 ...
 */
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":250
 *         if M > m:
 *             dx = bbuffer[0]
 *             dy = bbuffer[1]             # <<<<<<<<<<<<<< 
 *             GEOSCoordSeq_setX(cs, M-1, dx)
 ...
 */
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":251
 *             dx = bbuffer[0]
 *             dy = bbuffer[1]
 *             GEOSCoordSeq_setX(cs, M-1, dx)             # <<<<<<<<<<<<<< 
 *             GEOSCoordSeq_setY(cs, M-1, dy)
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":258
 * 
 *         # create Polygon from LinearRing (assuming no holes)
...
static PyObject *__pyx_f_py_4geos_7Polygon_area(PyObject *__pyx_v_self, PyObject *unused) {
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":263
 *     def area(self):
 *         cdef double area
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":264
 *         cdef double area
 *         GEOSArea(self._geom, &area)
 *         return area             # <<<<<<<<<<<<<< 
 * 
 ...
 */
  __pyx_1 = PyFloat_FromDouble(__pyx_v_area); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 264; goto __pyx_L1;}
  __pyx_r = __pyx_1;
  __pyx_1 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":275
 *     else:
 *         cs = GEOSGeom_getCoordSeq(geom)
 *     GEOSCoordSeq_getSize(cs, &M)             # <<<<<<<<<<<<<< 
 *     p._geom = geom
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":276
 *         cs = GEOSGeom_getCoordSeq(geom)
 *     GEOSCoordSeq_getSize(cs, &M)
 *     p._geom = geom             # <<<<<<<<<<<<<< 
 *     p._npts = M
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":277
 *     GEOSCoordSeq_getSize(cs, &M)
 *     p._geom = geom
 *     p._npts = M             # <<<<<<<<<<<<<< 
 *     return p
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":278
 *     p._geom = geom
 *     p._npts = M
 *     return p             # <<<<<<<<<<<<<< 
 * 
 ...
 *     for i from 0 <= i < M:
 */
  __pyx_2 = __Pyx_GetName(__pyx_m, __pyx_n_numpy); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 293; goto __pyx_L1;}
  __pyx_3 = PyObject_GetAttr(__pyx_2, __pyx_n_empty); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 293; goto __pyx_L1;}
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  __pyx_2 = PyLong_FromUnsignedLong(__pyx_v_M); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 293; goto __pyx_L1;}
  __pyx_4 = PyTuple_New(2); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 293; goto __pyx_L1;}
  PyTuple_SET_ITEM(__pyx_4, 0, __pyx_2);
  Py_INCREF(__pyx_num_2);
  PyTuple_SET_ITEM(__pyx_4, 1, __pyx_num_2);
  __pyx_2 = 0;
  __pyx_2 = __Pyx_GetName(__pyx_m, __pyx_n_numpy); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 293; goto __pyx_L1;}
  __pyx_5 = PyObject_GetAttr(__pyx_2, __pyx_n_float64); if (unlikely(!__pyx_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 293; goto __pyx_L1;}
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  __pyx_2 = PyTuple_New(2); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 293; goto __pyx_L1;}
  PyTuple_SET_ITEM(__pyx_2, 0, __pyx_4);
  PyTuple_SET_ITEM(__pyx_2, 1, __pyx_5);
  __pyx_4 = 0;
  __pyx_5 = 0;
  __pyx_4 = PyObject_CallObject(__pyx_3, __pyx_2); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 293; goto __pyx_L1;}
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  if (!__Pyx_TypeTest(__pyx_4, __pyx_ptype_4geos_ndarray)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 293; goto __pyx_L1;}
  Py_DECREF(((PyObject *)__pyx_v_b));
 ...
 */
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":297
 *     for i from 0 <= i < M:
 *         GEOSCoordSeq_getX(cs, i, &dx)
 *         GEOSCoordSeq_getY(cs, i, &dy)             # <<<<<<<<<<<<<< 
 *         bbuffer[2*i] = dx
 ...
 */
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":298
 *         GEOSCoordSeq_getX(cs, i, &dx)
 *         GEOSCoordSeq_getY(cs, i, &dy)
 *         bbuffer[2*i] = dx             # <<<<<<<<<<<<<< 
 *         bbuffer[2*i+1] = dy
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":300
 *         bbuffer[2*i] = dx
 *         bbuffer[2*i+1] = dy
 *     return b             # <<<<<<<<<<<<<< 
 * 
...
static int __pyx_f_py_4geos_10LineString___init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  Py_INCREF((PyObject *)__pyx_v_self);
  Py_INCREF(__pyx_v_b);
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_b), __pyx_ptype_4geos_ndarray, 1, "b"))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 303; goto __pyx_L1;}

  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":310
 * 
 *         # just return an empty class
 *         if b is None:             # <<<<<<<<<<<<<< 
 *             return
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":316
 *         # if not, make a local copy.
 *         if not PyArray_ISCONTIGUOUS(b):
 *             b = b.copy()             # <<<<<<<<<<<<<< 
 * 
 *         M = b.shape[0]
 */
    __pyx_2 = PyObject_GetAttr(((PyObject *)__pyx_v_b), __pyx_n_copy); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 316; goto __pyx_L1;}
    __pyx_3 = PyObject_CallObject(__pyx_2, 0); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 316; goto __pyx_L1;}
    Py_DECREF(__pyx_2); __pyx_2 = 0;
    if (!__Pyx_TypeTest(__pyx_3, __pyx_ptype_4geos_ndarray)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 316; goto __pyx_L1;}
    Py_DECREF(((PyObject *)__pyx_v_b));
    __pyx_v_b = ((PyArrayObject *)__pyx_3);
    __pyx_3 = 0;
    goto __pyx_L3;
 ...
 * 
 */
  __pyx_2 = PyObject_GetAttr(((PyObject *)__pyx_v_b), __pyx_n_shape); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 318; goto __pyx_L1;}
  if (PyList_CheckExact(__pyx_2) && 0 <= 0 && 0 < PyList_GET_SIZE(__pyx_2)) {
    __pyx_4 = PyList_GET_ITEM(__pyx_2, 0); Py_INCREF(__pyx_4);
    } else if (PyTuple_CheckExact(__pyx_2) && 0 <= 0 && 0 < PyTuple_GET_SIZE(__pyx_2)) {
    __pyx_4 = PyTuple_GET_ITEM(__pyx_2, 0); Py_INCREF(__pyx_4);
    } else {
    __pyx_3 = PyInt_FromLong(0); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 318; goto __pyx_L1;}
    __pyx_4 = PyObject_GetItem(__pyx_2, __pyx_3); if (unlikely(!__pyx_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 318; goto __pyx_L1;}
    Py_DECREF(__pyx_3); __pyx_3 = 0;
  }
  Py_DECREF(__pyx_2); __pyx_2 = 0;
  __pyx_5 = PyInt_AsLong(__pyx_4); if (unlikely((__pyx_5 == -1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 318; goto __pyx_L1;}
  Py_DECREF(__pyx_4); __pyx_4 = 0;
  __pyx_v_M = __pyx_5;

  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":319
 * 
 *         M = b.shape[0]
 *         self._npts = M             # <<<<<<<<<<<<<< 
 * 
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":325
 * 
 *         # add to coordinate sequence
 *         bbuffer = <double *>b.data             # <<<<<<<<<<<<<< 
 *         for i from 0 <= i < M:
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":326
 *         # add to coordinate sequence
 *         bbuffer = <double *>b.data
 *         for i from 0 <= i < M:             # <<<<<<<<<<<<<< 
 *             dx = bbuffer[2*i]
 ...
 */
    ...
    /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":332
 *             # always set X before Y
 *             GEOSCoordSeq_setX(cs, i, dx)
 *             GEOSCoordSeq_setY(cs, i, dy)             # <<<<<<<<<<<<<< 
 * 
 ...
 */
  if (PyList_CheckExact(__pyx_v_b) && 0 <= 0 && 0 < PyList_GET_SIZE(__pyx_v_b)) {
    ...
    __pyx_2 = PyInt_FromLong(0); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 347; goto __pyx_L1;}
    __pyx_3 = PyObject_GetItem(__pyx_v_b, __pyx_2); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 347; goto __pyx_L1;}
    Py_DECREF(__pyx_2); __pyx_2 = 0;
  }
  __pyx_4 = PyFloat_AsDouble(__pyx_3); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 347; goto __pyx_L1;}
  Py_DECREF(__pyx_3); __pyx_3 = 0;
  __pyx_v_dx = __pyx_4;
 ...
 */
  if (PyList_CheckExact(__pyx_v_b) && 0 <= 1 && 1 < PyList_GET_SIZE(__pyx_v_b)) {
    ...
    __pyx_2 = PyInt_FromLong(1); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 347; goto __pyx_L1;}
    __pyx_3 = PyObject_GetItem(__pyx_v_b, __pyx_2); if (unlikely(!__pyx_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 347; goto __pyx_L1;}
    Py_DECREF(__pyx_2); __pyx_2 = 0;
  }
  __pyx_4 = PyFloat_AsDouble(__pyx_3); if (unlikely(PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 347; goto __pyx_L1;}
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":348
 *         cs = GEOSCoordSeq_create(1, 2)
 *         dx = b[0]; dy = b[1]
 *         GEOSCoordSeq_setX(cs, 0, dx)             # <<<<<<<<<<<<<< 
 *         GEOSCoordSeq_setY(cs, 0, dy)
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":349
 *         dx = b[0]; dy = b[1]
 *         GEOSCoordSeq_setX(cs, 0, dx)
 *         GEOSCoordSeq_setY(cs, 0, dy)             # <<<<<<<<<<<<<< 
 *         self._geom = GEOSGeom_createPoint(cs)
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":350
 *         GEOSCoordSeq_setX(cs, 0, dx)
 *         GEOSCoordSeq_setY(cs, 0, dy)
 *         self._geom = GEOSGeom_createPoint(cs)             # <<<<<<<<<<<<<< 
 *         self._npts = 1
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":351
 *         GEOSCoordSeq_setY(cs, 0, dy)
 *         self._geom = GEOSGeom_createPoint(cs)
 *         self._npts = 1             # <<<<<<<<<<<<<< 
 */
...
static void __pyx_tp_dealloc_4geos_BaseGeometry(PyObject *o) {
  {
    ...
    ++o->ob_refcnt;
    __pyx_f_py_4geos_12BaseGeometry___dealloc__(o);
...
static struct PyMethodDef __pyx_methods_4geos_BaseGeometry[] = {
  ...
  {"__reduce__", (PyCFunction)__pyx_f_py_4geos_12BaseGeometry___reduce__, METH_NOARGS, __pyx_doc_4geos_12BaseGeometry___reduce__},
  {0, 0, 0, 0}
};
...
PyMODINIT_FUNC initgeos(void) {
  ...
  __pyx_builtin_NotImplementedError = __Pyx_GetName(__pyx_b, __pyx_n_NotImplementedError); if (!__pyx_builtin_NotImplementedError) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 193; goto __pyx_L1;}
  __pyx_ptype_4geos_ndarray = __Pyx_ImportType("numpy", "ndarray", sizeof(PyArrayObject)); if (unlikely(!__pyx_ptype_4geos_ndarray)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; goto __pyx_L1;}
  ...
  if (PyType_Ready(&__pyx_type_4geos_Polygon) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 207; goto __pyx_L1;}
  if (PyObject_SetAttrString(__pyx_m, "Polygon", (PyObject *)&__pyx_type_4geos_Polygon) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 207; goto __pyx_L1;}
  __pyx_ptype_4geos_Polygon = &__pyx_type_4geos_Polygon;
  __pyx_type_4geos_LineString.tp_base = __pyx_ptype_4geos_BaseGeometry;
  if (PyType_Ready(&__pyx_type_4geos_LineString) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 302; goto __pyx_L1;}
  if (PyObject_SetAttrString(__pyx_m, "LineString", (PyObject *)&__pyx_type_4geos_LineString) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 302; goto __pyx_L1;}
  ...
  if (PyType_Ready(&__pyx_type_4geos_Point) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 337; goto __pyx_L1;}
  if (PyObject_SetAttrString(__pyx_m, "Point", (PyObject *)&__pyx_type_4geos_Point) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 337; goto __pyx_L1;}
  __pyx_ptype_4geos_Point = &__pyx_type_4geos_Point;

  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":1
 * import sys             # <<<<<<<<<<<<<< 
 * import numpy
 * 
 */
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":26
 * 
 * # Initialize numpy
 * import_array()             # <<<<<<<<<<<<<< 
 * 
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":209
 * cdef class Polygon(BaseGeometry):
 * 
 ...
 */
  ...
  /* "/Users/jsw/python/matplotlib/toolkits/basemap-testing/src/geos.pyx":303
 * 
 * cdef class LineString(BaseGeometry):
 *     def __init__(self, ndarray b=None):             # <<<<<<<<<<<<<< 
 *         cdef double dx, dy

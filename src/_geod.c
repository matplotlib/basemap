/* Generated by Cython 0.9.6.7 on Wed Oct 31 21:20:49 2007 */
...
static int __pyx_f_py_5_geod_4Geod___new__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":13
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":15
 *         self.geodparams = geodparams
 *         # setup proj initialization string.
 *         geodargs = []             # <<<<<<<<<<<<<< 
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":16
 *         # setup proj initialization string.
 *         geodargs = []
 *         for key,value in geodparams.iteritems():             # <<<<<<<<<<<<<< 
 *             geodargs.append('+'+key+"="+str(value)+' ')
 ...
 */
  ...
  for (;;) {
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":17
 *         geodargs = []
 *         for key,value in geodparams.iteritems():
 *             geodargs.append('+'+key+"="+str(value)+' ')             # <<<<<<<<<<<<<< 
 *         self.geodinitstring = PyString_AsString(''.join(geodargs))
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":18
 *         for key,value in geodparams.iteritems():
 *             geodargs.append('+'+key+"="+str(value)+' ')
 *         self.geodinitstring = PyString_AsString(''.join(geodargs))             # <<<<<<<<<<<<<< 
 *         # initialize projection
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":20
 *         self.geodinitstring = PyString_AsString(''.join(geodargs))
 *         # initialize projection
 *         self.geodesic_t = GEOD_init_plus(self.geodinitstring, &GEOD_T)[0]             # <<<<<<<<<<<<<< 
 *         if pj_errno != 0:
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":21
 *         # initialize projection
 *         self.geodesic_t = GEOD_init_plus(self.geodinitstring, &GEOD_T)[0]
 *         if pj_errno != 0:             # <<<<<<<<<<<<<< 
 *             raise RuntimeError(pj_strerrno(pj_errno))
 ...
 */
  ...
  if (__pyx_7) {
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":22
 *         self.geodesic_t = GEOD_init_plus(self.geodinitstring, &GEOD_T)[0]
 *         if pj_errno != 0:
 *             raise RuntimeError(pj_strerrno(pj_errno))             # <<<<<<<<<<<<<< 
 *         self.proj_version = PJ_VERSION/100.
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":23
 *         if pj_errno != 0:
 *             raise RuntimeError(pj_strerrno(pj_errno))
 *         self.proj_version = PJ_VERSION/100.             # <<<<<<<<<<<<<< 
 * 
...
static PyObject *__pyx_f_py_5_geod_4Geod___reduce__(PyObject *__pyx_v_self, PyObject *unused) {
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":27
 *     def __reduce__(self):
...
static PyObject *__pyx_f_py_5_geod_4Geod__fwd(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":40
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":41
 *         # if buffer api is supported, get pointer to data buffers.
 *         if PyObject_AsWriteBuffer(lons, &londata, &buflenlons) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<< 
 *         if PyObject_AsWriteBuffer(lats, &latdata, &buflenlats) <> 0:
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":42
 *         if PyObject_AsWriteBuffer(lons, &londata, &buflenlons) <> 0:
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(lats, &latdata, &buflenlats) <> 0:             # <<<<<<<<<<<<<< 
 *             raise RuntimeError
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":43
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(lats, &latdata, &buflenlats) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<< 
 *         if PyObject_AsWriteBuffer(az, &azdat, &buflenaz) <> 0:
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":44
 *         if PyObject_AsWriteBuffer(lats, &latdata, &buflenlats) <> 0:
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(az, &azdat, &buflenaz) <> 0:             # <<<<<<<<<<<<<< 
 *             raise RuntimeError
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":45
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(az, &azdat, &buflenaz) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<< 
 *         if PyObject_AsWriteBuffer(dist, &distdat, &buflend) <> 0:
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":46
 *         if PyObject_AsWriteBuffer(az, &azdat, &buflenaz) <> 0:
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(dist, &distdat, &buflend) <> 0:             # <<<<<<<<<<<<<< 
 *             raise RuntimeError
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":47
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(dist, &distdat, &buflend) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<< 
 *         # process data in buffer
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":49
 *             raise RuntimeError
 *         # process data in buffer
 *         if not buflenlons == buflenlats == buflenaz == buflend:             # <<<<<<<<<<<<<< 
 ...
 */
  ...
  if (__pyx_2) {
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":50
 *         # process data in buffer
 *         if not buflenlons == buflenlats == buflenaz == buflend:
 *             raise RuntimeError("Buffer lengths not the same")             # <<<<<<<<<<<<<< 
 *         ndim = buflenlons/_doublesize
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":51
 *         if not buflenlons == buflenlats == buflenaz == buflend:
 *             raise RuntimeError("Buffer lengths not the same")
 *         ndim = buflenlons/_doublesize             # <<<<<<<<<<<<<< 
 *         lonsdata = <double *>londata
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":52
 *             raise RuntimeError("Buffer lengths not the same")
 *         ndim = buflenlons/_doublesize
 *         lonsdata = <double *>londata             # <<<<<<<<<<<<<< 
 *         latsdata = <double *>latdata
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":53
 *         ndim = buflenlons/_doublesize
 *         lonsdata = <double *>londata
 *         latsdata = <double *>latdata             # <<<<<<<<<<<<<< 
 *         azdata = <double *>azdat
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":54
 *         lonsdata = <double *>londata
 *         latsdata = <double *>latdata
 *         azdata = <double *>azdat             # <<<<<<<<<<<<<< 
 *         distdata = <double *>distdat
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":55
 *         latsdata = <double *>latdata
 *         azdata = <double *>azdat
 *         distdata = <double *>distdat             # <<<<<<<<<<<<<< 
 *         for i from 0 <= i < ndim:
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":56
 *         azdata = <double *>azdat
 *         distdata = <double *>distdat
 *         for i from 0 <= i < ndim:             # <<<<<<<<<<<<<< 
 *             if radians:
 ...
 */
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_v_ndim; __pyx_v_i++) {
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":57
 *         distdata = <double *>distdat
 *         for i from 0 <= i < ndim:
 *             if radians:             # <<<<<<<<<<<<<< 
 *                 self.geodesic_t.p1.v = lonsdata[i]
 ...
 */
    ...
    if (__pyx_1) {
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":58
 *         for i from 0 <= i < ndim:
 *             if radians:
 *                 self.geodesic_t.p1.v = lonsdata[i]             # <<<<<<<<<<<<<< 
 *                 self.geodesic_t.p1.u = latsdata[i]
 ...
 */
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":59
 *             if radians:
 *                 self.geodesic_t.p1.v = lonsdata[i]
 *                 self.geodesic_t.p1.u = latsdata[i]             # <<<<<<<<<<<<<< 
 *                 self.geodesic_t.ALPHA12 = azdata[i]
 ...
 */
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":60
 *                 self.geodesic_t.p1.v = lonsdata[i]
 *                 self.geodesic_t.p1.u = latsdata[i]
 *                 self.geodesic_t.ALPHA12 = azdata[i]             # <<<<<<<<<<<<<< 
 *                 self.geodesic_t.DIST = distdata[i]
 ...
 */
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":61
 *                 self.geodesic_t.p1.u = latsdata[i]
 *                 self.geodesic_t.ALPHA12 = azdata[i]
 *                 self.geodesic_t.DIST = distdata[i]             # <<<<<<<<<<<<<< 
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":63
 *                 self.geodesic_t.DIST = distdata[i]
 *             else:
 *                 self.geodesic_t.p1.v = _dg2rad*lonsdata[i]             # <<<<<<<<<<<<<< 
 ...
 */
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":64
 *             else:
 *                 self.geodesic_t.p1.v = _dg2rad*lonsdata[i]
 *                 self.geodesic_t.p1.u = _dg2rad*latsdata[i]             # <<<<<<<<<<<<<< 
 *                 self.geodesic_t.ALPHA12 = _dg2rad*azdata[i]
 ...
 */
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":65
 *                 self.geodesic_t.p1.v = _dg2rad*lonsdata[i]
 *                 self.geodesic_t.p1.u = _dg2rad*latsdata[i]
 *                 self.geodesic_t.ALPHA12 = _dg2rad*azdata[i]             # <<<<<<<<<<<<<< 
 *                 self.geodesic_t.DIST = distdata[i]
 ...
 */
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":66
 *                 self.geodesic_t.p1.u = _dg2rad*latsdata[i]
 *                 self.geodesic_t.ALPHA12 = _dg2rad*azdata[i]
 *                 self.geodesic_t.DIST = distdata[i]             # <<<<<<<<<<<<<< 
 *             geod_pre(&self.geodesic_t)
 ...
 */
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":67
 *                 self.geodesic_t.ALPHA12 = _dg2rad*azdata[i]
 *                 self.geodesic_t.DIST = distdata[i]
 *             geod_pre(&self.geodesic_t)             # <<<<<<<<<<<<<< 
 *             if pj_errno != 0:
 ...
 */
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":68
 *                 self.geodesic_t.DIST = distdata[i]
 *             geod_pre(&self.geodesic_t)
 *             if pj_errno != 0:             # <<<<<<<<<<<<<< 
 *                 raise RuntimeError(pj_strerrno(pj_errno))
 ...
 */
    ...
    if (__pyx_2) {
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":69
 *             geod_pre(&self.geodesic_t)
 *             if pj_errno != 0:
 *                 raise RuntimeError(pj_strerrno(pj_errno))             # <<<<<<<<<<<<<< 
 *             geod_for(&self.geodesic_t)
 ...
 */
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":70
 *             if pj_errno != 0:
 *                 raise RuntimeError(pj_strerrno(pj_errno))
 *             geod_for(&self.geodesic_t)             # <<<<<<<<<<<<<< 
 *             if pj_errno != 0:
 ...
 */
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":71
 *                 raise RuntimeError(pj_strerrno(pj_errno))
 *             geod_for(&self.geodesic_t)
 *             if pj_errno != 0:             # <<<<<<<<<<<<<< 
 *                 raise RuntimeError(pj_strerrno(pj_errno))
 ...
 */
    ...
    if (__pyx_1) {
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":72
 *             geod_for(&self.geodesic_t)
 *             if pj_errno != 0:
 *                 raise RuntimeError(pj_strerrno(pj_errno))             # <<<<<<<<<<<<<< 
 *             if isnan(self.geodesic_t.ALPHA21):
 ...
 */
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":73
 *             if pj_errno != 0:
 *                 raise RuntimeError(pj_strerrno(pj_errno))
 *             if isnan(self.geodesic_t.ALPHA21):             # <<<<<<<<<<<<<< 
 *                 raise ValueError('undefined forward geodesic (may be an equatorial arc)')
 ...
 */
    ...
    if (__pyx_8) {
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":74
 *                 raise RuntimeError(pj_strerrno(pj_errno))
 *             if isnan(self.geodesic_t.ALPHA21):
 *                 raise ValueError('undefined forward geodesic (may be an equatorial arc)')             # <<<<<<<<<<<<<< 
 *             if radians:
 ...
 */
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":75
 *             if isnan(self.geodesic_t.ALPHA21):
 *                 raise ValueError('undefined forward geodesic (may be an equatorial arc)')
 *             if radians:             # <<<<<<<<<<<<<< 
 *                 lonsdata[i] = self.geodesic_t.p2.v
 ...
 */
    ...
    if (__pyx_2) {
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":76
 *                 raise ValueError('undefined forward geodesic (may be an equatorial arc)')
 *             if radians:
 *                 lonsdata[i] = self.geodesic_t.p2.v             # <<<<<<<<<<<<<< 
 *                 latsdata[i] = self.geodesic_t.p2.u
 ...
 */
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":77
 *             if radians:
 *                 lonsdata[i] = self.geodesic_t.p2.v
 *                 latsdata[i] = self.geodesic_t.p2.u             # <<<<<<<<<<<<<< 
 *                 azdata[i] = self.geodesic_t.ALPHA21
 ...
 */
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":78
 *                 lonsdata[i] = self.geodesic_t.p2.v
 *                 latsdata[i] = self.geodesic_t.p2.u
 *                 azdata[i] = self.geodesic_t.ALPHA21             # <<<<<<<<<<<<<< 
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":80
 *                 azdata[i] = self.geodesic_t.ALPHA21
 *             else:
 *                 lonsdata[i] = _rad2dg*self.geodesic_t.p2.v             # <<<<<<<<<<<<<< 
 ...
 */
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":81
 *             else:
 *                 lonsdata[i] = _rad2dg*self.geodesic_t.p2.v
 *                 latsdata[i] = _rad2dg*self.geodesic_t.p2.u             # <<<<<<<<<<<<<< 
 *                 azdata[i] = _rad2dg*self.geodesic_t.ALPHA21
 ...
 */
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":82
 *                 lonsdata[i] = _rad2dg*self.geodesic_t.p2.v
 *                 latsdata[i] = _rad2dg*self.geodesic_t.p2.u
 *                 azdata[i] = _rad2dg*self.geodesic_t.ALPHA21             # <<<<<<<<<<<<<< 
 * 
...
static PyObject *__pyx_f_py_5_geod_4Geod__inv(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":94
 *         cdef void *londata, *latdata, *azdat, *distdat
 *         # if buffer api is supported, get pointer to data buffers.
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":95
 *         # if buffer api is supported, get pointer to data buffers.
 *         if PyObject_AsWriteBuffer(lons1, &londata, &buflenlons) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<< 
 *         if PyObject_AsWriteBuffer(lats1, &latdata, &buflenlats) <> 0:
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":96
 *         if PyObject_AsWriteBuffer(lons1, &londata, &buflenlons) <> 0:
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(lats1, &latdata, &buflenlats) <> 0:             # <<<<<<<<<<<<<< 
 *             raise RuntimeError
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":97
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(lats1, &latdata, &buflenlats) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<< 
 *         if PyObject_AsWriteBuffer(lons2, &azdat, &buflenaz) <> 0:
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":98
 *         if PyObject_AsWriteBuffer(lats1, &latdata, &buflenlats) <> 0:
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(lons2, &azdat, &buflenaz) <> 0:             # <<<<<<<<<<<<<< 
 *             raise RuntimeError
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":99
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(lons2, &azdat, &buflenaz) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<< 
 *         if PyObject_AsWriteBuffer(lats2, &distdat, &buflend) <> 0:
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":100
 *         if PyObject_AsWriteBuffer(lons2, &azdat, &buflenaz) <> 0:
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(lats2, &distdat, &buflend) <> 0:             # <<<<<<<<<<<<<< 
 *             raise RuntimeError
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":101
 *             raise RuntimeError
 *         if PyObject_AsWriteBuffer(lats2, &distdat, &buflend) <> 0:
 *             raise RuntimeError             # <<<<<<<<<<<<<< 
 *         # process data in buffer
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":103
 *             raise RuntimeError
 *         # process data in buffer
 *         if not buflenlons == buflenlats == buflenaz == buflend:             # <<<<<<<<<<<<<< 
 *             raise RuntimeError("Buffer lengths not the same")
 ...
 */
  ...
  if (__pyx_2) {
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":104
 *         # process data in buffer
 *         if not buflenlons == buflenlats == buflenaz == buflend:
 *             raise RuntimeError("Buffer lengths not the same")             # <<<<<<<<<<<<<< 
 *         ndim = buflenlons/_doublesize
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":105
 *         if not buflenlons == buflenlats == buflenaz == buflend:
 *             raise RuntimeError("Buffer lengths not the same")
 *         ndim = buflenlons/_doublesize             # <<<<<<<<<<<<<< 
 *         lonsdata = <double *>londata
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":106
 *             raise RuntimeError("Buffer lengths not the same")
 *         ndim = buflenlons/_doublesize
 *         lonsdata = <double *>londata             # <<<<<<<<<<<<<< 
 *         latsdata = <double *>latdata
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":107
 *         ndim = buflenlons/_doublesize
 *         lonsdata = <double *>londata
 *         latsdata = <double *>latdata             # <<<<<<<<<<<<<< 
 *         azdata = <double *>azdat
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":108
 *         lonsdata = <double *>londata
 *         latsdata = <double *>latdata
 *         azdata = <double *>azdat             # <<<<<<<<<<<<<< 
 *         distdata = <double *>distdat
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":109
 *         latsdata = <double *>latdata
 *         azdata = <double *>azdat
 *         distdata = <double *>distdat             # <<<<<<<<<<<<<< 
 *         for i from 0 <= i < ndim:
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":110
 *         azdata = <double *>azdat
 *         distdata = <double *>distdat
 *         for i from 0 <= i < ndim:             # <<<<<<<<<<<<<< 
 *             if radians:
 ...
 */
  for (__pyx_v_i = 0; __pyx_v_i < __pyx_v_ndim; __pyx_v_i++) {
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":111
 *         distdata = <double *>distdat
 *         for i from 0 <= i < ndim:
 *             if radians:             # <<<<<<<<<<<<<< 
 *                 self.geodesic_t.p1.v = lonsdata[i]
 ...
 */
    ...
    if (__pyx_1) {
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":112
 *         for i from 0 <= i < ndim:
 *             if radians:
 *                 self.geodesic_t.p1.v = lonsdata[i]             # <<<<<<<<<<<<<< 
 *                 self.geodesic_t.p1.u = latsdata[i]
 ...
 */
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":113
 *             if radians:
 *                 self.geodesic_t.p1.v = lonsdata[i]
 *                 self.geodesic_t.p1.u = latsdata[i]             # <<<<<<<<<<<<<< 
 *                 self.geodesic_t.p2.v = azdata[i]
 ...
 */
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":114
 *                 self.geodesic_t.p1.v = lonsdata[i]
 *                 self.geodesic_t.p1.u = latsdata[i]
 *                 self.geodesic_t.p2.v = azdata[i]             # <<<<<<<<<<<<<< 
 *                 self.geodesic_t.p2.u = distdata[i]
 ...
 */
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":115
 *                 self.geodesic_t.p1.u = latsdata[i]
 *                 self.geodesic_t.p2.v = azdata[i]
 *                 self.geodesic_t.p2.u = distdata[i]             # <<<<<<<<<<<<<< 
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":117
 *                 self.geodesic_t.p2.u = distdata[i]
 *             else:
 *                 self.geodesic_t.p1.v = _dg2rad*lonsdata[i]             # <<<<<<<<<<<<<< 
 *                 self.geodesic_t.p1.u = _dg2rad*latsdata[i]
 ...
 */
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":118
 *             else:
 *                 self.geodesic_t.p1.v = _dg2rad*lonsdata[i]
 *                 self.geodesic_t.p1.u = _dg2rad*latsdata[i]             # <<<<<<<<<<<<<< 
 *                 self.geodesic_t.p2.v = _dg2rad*azdata[i]
 ...
 */
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":119
 *                 self.geodesic_t.p1.v = _dg2rad*lonsdata[i]
 *                 self.geodesic_t.p1.u = _dg2rad*latsdata[i]
 *                 self.geodesic_t.p2.v = _dg2rad*azdata[i]             # <<<<<<<<<<<<<< 
 *                 self.geodesic_t.p2.u = _dg2rad*distdata[i]
 ...
 */
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":120
 *                 self.geodesic_t.p1.u = _dg2rad*latsdata[i]
 *                 self.geodesic_t.p2.v = _dg2rad*azdata[i]
 *                 self.geodesic_t.p2.u = _dg2rad*distdata[i]             # <<<<<<<<<<<<<< 
 *             geod_inv(&self.geodesic_t)
 ...
 */
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":121
 *                 self.geodesic_t.p2.v = _dg2rad*azdata[i]
 *                 self.geodesic_t.p2.u = _dg2rad*distdata[i]
 *             geod_inv(&self.geodesic_t)             # <<<<<<<<<<<<<< 
 *             if isnan(self.geodesic_t.DIST):
 ...
 */
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":122
 *                 self.geodesic_t.p2.u = _dg2rad*distdata[i]
 *             geod_inv(&self.geodesic_t)
 *             if isnan(self.geodesic_t.DIST):             # <<<<<<<<<<<<<< 
 *                 raise ValueError('undefined inverse geodesic (may be an antipodal point)')
 ...
 */
    ...
    if (__pyx_8) {
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":123
 *             geod_inv(&self.geodesic_t)
 *             if isnan(self.geodesic_t.DIST):
 *                 raise ValueError('undefined inverse geodesic (may be an antipodal point)')             # <<<<<<<<<<<<<< 
 *             if pj_errno != 0:
 ...
 */
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":124
 *             if isnan(self.geodesic_t.DIST):
 *                 raise ValueError('undefined inverse geodesic (may be an antipodal point)')
 *             if pj_errno != 0:             # <<<<<<<<<<<<<< 
 *                 raise RuntimeError(pj_strerrno(pj_errno))
 ...
 */
    ...
    if (__pyx_2) {
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":125
 *                 raise ValueError('undefined inverse geodesic (may be an antipodal point)')
 *             if pj_errno != 0:
 *                 raise RuntimeError(pj_strerrno(pj_errno))             # <<<<<<<<<<<<<< 
 *             if radians:
 ...
 */
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":126
 *             if pj_errno != 0:
 *                 raise RuntimeError(pj_strerrno(pj_errno))
 *             if radians:             # <<<<<<<<<<<<<< 
 *                 lonsdata[i] = self.geodesic_t.ALPHA12
 ...
 */
    ...
    if (__pyx_1) {
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":127
 *                 raise RuntimeError(pj_strerrno(pj_errno))
 *             if radians:
 *                 lonsdata[i] = self.geodesic_t.ALPHA12             # <<<<<<<<<<<<<< 
 *                 latsdata[i] = self.geodesic_t.ALPHA21
 ...
 */
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":128
 *             if radians:
 *                 lonsdata[i] = self.geodesic_t.ALPHA12
 *                 latsdata[i] = self.geodesic_t.ALPHA21             # <<<<<<<<<<<<<< 
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":130
 *                 latsdata[i] = self.geodesic_t.ALPHA21
 *             else:
 *                 lonsdata[i] = _rad2dg*self.geodesic_t.ALPHA12             # <<<<<<<<<<<<<< 
 ...
 */
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":131
 *             else:
 *                 lonsdata[i] = _rad2dg*self.geodesic_t.ALPHA12
 *                 latsdata[i] = _rad2dg*self.geodesic_t.ALPHA21             # <<<<<<<<<<<<<< 
 *             azdata[i] = self.geodesic_t.DIST
 ...
 */
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":132
 *                 lonsdata[i] = _rad2dg*self.geodesic_t.ALPHA12
 *                 latsdata[i] = _rad2dg*self.geodesic_t.ALPHA21
 *             azdata[i] = self.geodesic_t.DIST             # <<<<<<<<<<<<<< 
 * 
...
static PyObject *__pyx_f_py_5_geod_4Geod__npts(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":139
 *         cdef int i
 *         cdef double del_s
 *         if radians:             # <<<<<<<<<<<<<< 
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":140
 *         cdef double del_s
 *         if radians:
 *             self.geodesic_t.p1.v = lon1             # <<<<<<<<<<<<<< 
 *             self.geodesic_t.p1.u = lat1
 ...
 */
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":141
 *         if radians:
 *             self.geodesic_t.p1.v = lon1
 *             self.geodesic_t.p1.u = lat1             # <<<<<<<<<<<<<< 
 *             self.geodesic_t.p2.v = lon2
 ...
 */
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":142
 *             self.geodesic_t.p1.v = lon1
 *             self.geodesic_t.p1.u = lat1
 *             self.geodesic_t.p2.v = lon2             # <<<<<<<<<<<<<< 
 *             self.geodesic_t.p2.u = lat2
 ...
 */
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":143
 *             self.geodesic_t.p1.u = lat1
 *             self.geodesic_t.p2.v = lon2
 *             self.geodesic_t.p2.u = lat2             # <<<<<<<<<<<<<< 
 *         else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":145
 *             self.geodesic_t.p2.u = lat2
 *         else:
 *             self.geodesic_t.p1.v = _dg2rad*lon1             # <<<<<<<<<<<<<< 
 ...
 */
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":146
 *         else:
 *             self.geodesic_t.p1.v = _dg2rad*lon1
 *             self.geodesic_t.p1.u = _dg2rad*lat1             # <<<<<<<<<<<<<< 
 *             self.geodesic_t.p2.v = _dg2rad*lon2
 ...
 */
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":147
 *             self.geodesic_t.p1.v = _dg2rad*lon1
 *             self.geodesic_t.p1.u = _dg2rad*lat1
 *             self.geodesic_t.p2.v = _dg2rad*lon2             # <<<<<<<<<<<<<< 
 *             self.geodesic_t.p2.u = _dg2rad*lat2
 ...
 */
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":148
 *             self.geodesic_t.p1.u = _dg2rad*lat1
 *             self.geodesic_t.p2.v = _dg2rad*lon2
 *             self.geodesic_t.p2.u = _dg2rad*lat2             # <<<<<<<<<<<<<< 
 *         # do inverse computation to set azimuths, distance.
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":150
 *             self.geodesic_t.p2.u = _dg2rad*lat2
 *         # do inverse computation to set azimuths, distance.
 *         geod_inv(&self.geodesic_t)             # <<<<<<<<<<<<<< 
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":152
 *         geod_inv(&self.geodesic_t)
 *         # set up some constants needed for forward computation.
 *         geod_pre(&self.geodesic_t)             # <<<<<<<<<<<<<< 
 *         # distance increment.
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":154
 *         geod_pre(&self.geodesic_t)
 *         # distance increment.
 *         del_s = self.geodesic_t.DIST/(npts+1)             # <<<<<<<<<<<<<< 
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":156
 *         del_s = self.geodesic_t.DIST/(npts+1)
 *         # initialize output tuples.
 *         lats = ()             # <<<<<<<<<<<<<< 
 *         lons = ()
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":157
 *         # initialize output tuples.
 *         lats = ()
 *         lons = ()             # <<<<<<<<<<<<<< 
 *         # loop over intermediate points, compute lat/lons.
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":159
 *         lons = ()
 *         # loop over intermediate points, compute lat/lons.
 *         for i from 1 <= i < npts+1:             # <<<<<<<<<<<<<< 
 ...
 */
  ...
  for (__pyx_v_i = 1; __pyx_v_i < __pyx_6; __pyx_v_i++) {
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":160
 *         # loop over intermediate points, compute lat/lons.
 *         for i from 1 <= i < npts+1:
 *             self.geodesic_t.DIST = i*del_s             # <<<<<<<<<<<<<< 
 *             geod_for(&self.geodesic_t)
 ...
 */
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":161
 *         for i from 1 <= i < npts+1:
 *             self.geodesic_t.DIST = i*del_s
 *             geod_for(&self.geodesic_t)             # <<<<<<<<<<<<<< 
 *             if radians:
 ...
 */
    ...
    /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":162
 *             self.geodesic_t.DIST = i*del_s
 *             geod_for(&self.geodesic_t)
 *             if radians:             # <<<<<<<<<<<<<< 
 *                 lats = lats + (self.geodesic_t.p2.u,)
 ...
 */
    ...
    if (__pyx_1) {
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":163
 *             geod_for(&self.geodesic_t)
 *             if radians:
 *                 lats = lats + (self.geodesic_t.p2.u,)             # <<<<<<<<<<<<<< 
 *                 lons = lons + (self.geodesic_t.p2.v,)
 ...
 */
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":164
 *             if radians:
 *                 lats = lats + (self.geodesic_t.p2.u,)
 *                 lons = lons + (self.geodesic_t.p2.v,)             # <<<<<<<<<<<<<< 
 *             else:
 ...
 */
    ...
    /*else*/ {
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":166
 *                 lons = lons + (self.geodesic_t.p2.v,)
 *             else:
 *                 lats = lats + (_rad2dg*self.geodesic_t.p2.u,)             # <<<<<<<<<<<<<< 
 ...
 */
      ...
      /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":167
 *             else:
 *                 lats = lats + (_rad2dg*self.geodesic_t.p2.u,)
 *                 lons = lons + (_rad2dg*self.geodesic_t.p2.v,)             # <<<<<<<<<<<<<< 
 *         return lons, lats   
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":168
 *                 lats = lats + (_rad2dg*self.geodesic_t.p2.u,)
 *                 lons = lons + (_rad2dg*self.geodesic_t.p2.v,)
 *         return lons, lats             # <<<<<<<<<<<<<< 
 */
...
PyMODINIT_FUNC init_geod(void) {
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_pyproj.pxi":1
 * import math             # <<<<<<<<<<<<<< 
 * 
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_pyproj.pxi":3
 * import math
 * 
 * _dg2rad = math.radians(1.)             # <<<<<<<<<<<<<< 
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_pyproj.pxi":4
 * 
 * _dg2rad = math.radians(1.)
 * _rad2dg = math.degrees(1.)             # <<<<<<<<<<<<<< 
 * _doublesize = sizeof(double)
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_pyproj.pxi":5
 * _dg2rad = math.radians(1.)
 * _rad2dg = math.degrees(1.)
 * _doublesize = sizeof(double)             # <<<<<<<<<<<<<< 
 * __version__ = "1.8.3"
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_pyproj.pxi":6
 * _rad2dg = math.degrees(1.)
 * _doublesize = sizeof(double)
 * __version__ = "1.8.3"             # <<<<<<<<<<<<<< 
 * 
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":29
 *         return (self.__class__,(self.geodparams,))
 * 
 *     def _fwd(self, object lons, object lats, object az, object dist, radians=False):             # <<<<<<<<<<<<<< 
 *         """
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":84
 *                 azdata[i] = _rad2dg*self.geodesic_t.ALPHA21
 * 
 *     def _inv(self, object lons1, object lats1, object lons2, object lats2, radians=False):             # <<<<<<<<<<<<<< 
 *         """
 ...
 */
  ...
  /* "/private/tmp/toolkits/basemap-testing/src/_geod.pyx":134
 *             azdata[i] = self.geodesic_t.DIST
 * 
 *     def _npts(self, double lon1, double lat1, double lon2, double lat2, int npts, radians=False):             # <<<<<<<<<<<<<< 
 *         """

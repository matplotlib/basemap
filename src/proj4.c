/* Generated by Pyrex 0.9.3 on Fri Nov 18 13:06:27 2005 */
...
static PyObject *__pyx_n_dtypechar;
...
static PyObject *__pyx_f_5proj4_4Proj___call__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  /*except:*/ {
    ...
    /*try:*/ {
      ...
      __pyx_2 = PyObject_GetAttr(__pyx_v_lon, __pyx_n_dtypechar); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 309; goto __pyx_L6;}
      if (PyObject_Cmp(__pyx_2, __pyx_n_d, &__pyx_4) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 309; goto __pyx_L6;}
      __pyx_4 = __pyx_4 != 0;
      Py_DECREF(__pyx_2); __pyx_2 = 0;
      if (__pyx_4) {

        /* "/Volumes/User/jsw/python/matplotlib/basemap_cvs/toolkits/basemap/src/proj4.pyx":310 */
        __pyx_3 = PyObject_GetAttr(__pyx_v_lon, __pyx_n_astype); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 310; goto __pyx_L6;}
        __pyx_1 = PyTuple_New(1); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 310; goto __pyx_L6;}
        Py_INCREF(__pyx_n_d);
        PyTuple_SET_ITEM(__pyx_1, 0, __pyx_n_d);
        __pyx_2 = PyObject_CallObject(__pyx_3, __pyx_1); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 310; goto __pyx_L6;}
        Py_DECREF(__pyx_3); __pyx_3 = 0;
        Py_DECREF(__pyx_1); __pyx_1 = 0;
        Py_DECREF(__pyx_v_lon);
        __pyx_v_lon = __pyx_2;
      ...
      __pyx_3 = PyObject_GetAttr(__pyx_v_lat, __pyx_n_dtypechar); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 311; goto __pyx_L6;}
      if (PyObject_Cmp(__pyx_3, __pyx_n_d, &__pyx_4) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 311; goto __pyx_L6;}
      __pyx_4 = __pyx_4 != 0;
      Py_DECREF(__pyx_3); __pyx_3 = 0;
      if (__pyx_4) {

        /* "/Volumes/User/jsw/python/matplotlib/basemap_cvs/toolkits/basemap/src/proj4.pyx":312 */
        __pyx_1 = PyObject_GetAttr(__pyx_v_lat, __pyx_n_astype); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 312; goto __pyx_L6;}
        __pyx_2 = PyTuple_New(1); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 312; goto __pyx_L6;}
        Py_INCREF(__pyx_n_d);
        PyTuple_SET_ITEM(__pyx_2, 0, __pyx_n_d);
        __pyx_3 = PyObject_CallObject(__pyx_1, __pyx_2); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 312; goto __pyx_L6;}
        Py_DECREF(__pyx_1); __pyx_1 = 0;
        Py_DECREF(__pyx_2); __pyx_2 = 0;
        Py_DECREF(__pyx_v_lat);
        __pyx_v_lat = __pyx_3;
    ...
    /*except:*/ {
      __Pyx_AddTraceback("proj4.__call__");
      __pyx_1 = __Pyx_GetExcValue(); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 313; goto __pyx_L1;}
      Py_DECREF(__pyx_1); __pyx_1 = 0;
      ...
      /*try:*/ {
        ...
        __pyx_2 = PyObject_GetAttr(__pyx_v_lon, __pyx_n_typecode); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 316; goto __pyx_L10;}
        if (PyObject_Cmp(__pyx_2, __pyx_n_d, &__pyx_4) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 316; goto __pyx_L10;}
        __pyx_4 = __pyx_4 != 0;
        Py_DECREF(__pyx_2); __pyx_2 = 0;
        if (__pyx_4) {

          /* "/Volumes/User/jsw/python/matplotlib/basemap_cvs/toolkits/basemap/src/proj4.pyx":317 */
          __pyx_3 = __Pyx_GetName(__pyx_m, __pyx_n_array); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 317; goto __pyx_L10;}
          __pyx_1 = PyObject_GetAttr(__pyx_3, __pyx_n_array); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 317; goto __pyx_L10;}
          Py_DECREF(__pyx_3); __pyx_3 = 0;
          __pyx_2 = PyTuple_New(2); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 317; goto __pyx_L10;}
          Py_INCREF(__pyx_n_d);
          PyTuple_SET_ITEM(__pyx_2, 0, __pyx_n_d);
          Py_INCREF(__pyx_v_lon);
          PyTuple_SET_ITEM(__pyx_2, 1, __pyx_v_lon);
          __pyx_3 = PyObject_CallObject(__pyx_1, __pyx_2); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 317; goto __pyx_L10;}
          Py_DECREF(__pyx_1); __pyx_1 = 0;
          Py_DECREF(__pyx_2); __pyx_2 = 0;
          Py_DECREF(__pyx_v_lon);
          __pyx_v_lon = __pyx_3;
        ...
        __pyx_1 = PyObject_GetAttr(__pyx_v_lat, __pyx_n_typecode); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 318; goto __pyx_L10;}
        if (PyObject_Cmp(__pyx_1, __pyx_n_d, &__pyx_4) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 318; goto __pyx_L10;}
        __pyx_4 = __pyx_4 != 0;
        Py_DECREF(__pyx_1); __pyx_1 = 0;
        if (__pyx_4) {

          /* "/Volumes/User/jsw/python/matplotlib/basemap_cvs/toolkits/basemap/src/proj4.pyx":319 */
          __pyx_2 = __Pyx_GetName(__pyx_m, __pyx_n_array); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 319; goto __pyx_L10;}
          __pyx_3 = PyObject_GetAttr(__pyx_2, __pyx_n_array); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 319; goto __pyx_L10;}
          Py_DECREF(__pyx_2); __pyx_2 = 0;
          __pyx_1 = PyTuple_New(2); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 319; goto __pyx_L10;}
          Py_INCREF(__pyx_n_d);
          PyTuple_SET_ITEM(__pyx_1, 0, __pyx_n_d);
          Py_INCREF(__pyx_v_lat);
          PyTuple_SET_ITEM(__pyx_1, 1, __pyx_v_lat);
          __pyx_2 = PyObject_CallObject(__pyx_3, __pyx_1); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 319; goto __pyx_L10;}
          Py_DECREF(__pyx_3); __pyx_3 = 0;
          Py_DECREF(__pyx_1); __pyx_1 = 0;
          Py_DECREF(__pyx_v_lat);
          __pyx_v_lat = __pyx_2;
      ...
      /*except:*/ {
        __Pyx_AddTraceback("proj4.__call__");
        __pyx_3 = __Pyx_GetExcValue(); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 320; goto __pyx_L1;}
        Py_DECREF(__pyx_3); __pyx_3 = 0;
  ...
  if (__pyx_4) {
    ...
    /*try:*/ {
      ...
      __pyx_1 = PyObject_GetAttr(__pyx_v_lon, __pyx_n___copy__); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 333; goto __pyx_L15;}
      __pyx_2 = PyTuple_New(0); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 333; goto __pyx_L15;}
      __pyx_3 = PyObject_CallObject(__pyx_1, __pyx_2); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 333; goto __pyx_L15;}
      Py_DECREF(__pyx_1); __pyx_1 = 0;
      Py_DECREF(__pyx_2); __pyx_2 = 0;
      ...
      /* "/Volumes/User/jsw/python/matplotlib/basemap_cvs/toolkits/basemap/src/proj4.pyx":333 */
      __pyx_1 = PyObject_GetAttr(__pyx_v_lat, __pyx_n___copy__); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 333; goto __pyx_L15;}
      __pyx_2 = PyTuple_New(0); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 333; goto __pyx_L15;}
      __pyx_3 = PyObject_CallObject(__pyx_1, __pyx_2); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 333; goto __pyx_L15;}
      Py_DECREF(__pyx_1); __pyx_1 = 0;
      Py_DECREF(__pyx_2); __pyx_2 = 0;
    ...
    /*except:*/ {
      __Pyx_AddTraceback("proj4.__call__");
      __pyx_1 = __Pyx_GetExcValue(); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 334; goto __pyx_L1;}
      Py_DECREF(__pyx_1); __pyx_1 = 0;
    ...
    if (__pyx_4) {
      ...
      __pyx_3 = PyObject_GetAttr(__pyx_v_self, __pyx_n__inv); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 342; goto __pyx_L1;}
      ...
      __pyx_2 = PyDict_New(); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 342; goto __pyx_L1;}
      if (PyDict_SetItem(__pyx_2, __pyx_n_radians, __pyx_v_radians) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 342; goto __pyx_L1;}
      __pyx_5 = PyEval_CallObjectWithKeywords(__pyx_3, __pyx_1, __pyx_2); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 342; goto __pyx_L1;}
      Py_DECREF(__pyx_3); __pyx_3 = 0;
      Py_DECREF(__pyx_1); __pyx_1 = 0;
      Py_DECREF(__pyx_2); __pyx_2 = 0;
      __pyx_3 = __Pyx_UnpackItem(__pyx_5, 0); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 342; goto __pyx_L1;}
      Py_DECREF(__pyx_v_outx);
      __pyx_v_outx = __pyx_3;
      __pyx_3 = 0;
      __pyx_1 = __Pyx_UnpackItem(__pyx_5, 1); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 342; goto __pyx_L1;}
    ...
    /*else*/ {
      ...
      __pyx_2 = PyObject_GetAttr(__pyx_v_self, __pyx_n__fwd); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 344; goto __pyx_L1;}
      __pyx_3 = PyTuple_New(2); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 344; goto __pyx_L1;}
      Py_INCREF(__pyx_v_inx);
      PyTuple_SET_ITEM(__pyx_3, 0, __pyx_v_inx);
      Py_INCREF(__pyx_v_iny);
      PyTuple_SET_ITEM(__pyx_3, 1, __pyx_v_iny);
      __pyx_1 = PyDict_New(); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 344; goto __pyx_L1;}
      if (PyDict_SetItem(__pyx_1, __pyx_n_radians, __pyx_v_radians) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 344; goto __pyx_L1;}
      __pyx_5 = PyEval_CallObjectWithKeywords(__pyx_2, __pyx_3, __pyx_1); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 344; goto __pyx_L1;}
      Py_DECREF(__pyx_2); __pyx_2 = 0;
      Py_DECREF(__pyx_3); __pyx_3 = 0;
      Py_DECREF(__pyx_1); __pyx_1 = 0;
      __pyx_2 = __Pyx_UnpackItem(__pyx_5, 0); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 344; goto __pyx_L1;}
      Py_DECREF(__pyx_v_outx);
      __pyx_v_outx = __pyx_2;
      __pyx_2 = 0;
      __pyx_3 = __Pyx_UnpackItem(__pyx_5, 1); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 344; goto __pyx_L1;}
      Py_DECREF(__pyx_v_outy);
  ...
  /*else*/ {
    ...
    if (__pyx_4) {
      ...
      __pyx_1 = PyObject_GetAttr(__pyx_v_self, __pyx_n__inv); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 348; goto __pyx_L1;}
      ...
      __pyx_3 = PyDict_New(); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 348; goto __pyx_L1;}
      if (PyDict_SetItem(__pyx_3, __pyx_n_radians, __pyx_v_radians) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 348; goto __pyx_L1;}
      __pyx_5 = PyEval_CallObjectWithKeywords(__pyx_1, __pyx_2, __pyx_3); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 348; goto __pyx_L1;}
      Py_DECREF(__pyx_1); __pyx_1 = 0;
      Py_DECREF(__pyx_2); __pyx_2 = 0;
      Py_DECREF(__pyx_3); __pyx_3 = 0;
      __pyx_1 = __Pyx_UnpackItem(__pyx_5, 0); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 348; goto __pyx_L1;}
      Py_DECREF(__pyx_v_outx);
      __pyx_v_outx = __pyx_1;
      __pyx_1 = 0;
      __pyx_2 = __Pyx_UnpackItem(__pyx_5, 1); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 348; goto __pyx_L1;}
      Py_DECREF(__pyx_v_outy);
    ...
    /*else*/ {
      ...
      __pyx_3 = PyObject_GetAttr(__pyx_v_self, __pyx_n__fwd); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 350; goto __pyx_L1;}
      __pyx_1 = PyTuple_New(2); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 350; goto __pyx_L1;}
      Py_INCREF(__pyx_v_lon);
      PyTuple_SET_ITEM(__pyx_1, 0, __pyx_v_lon);
      Py_INCREF(__pyx_v_lat);
      PyTuple_SET_ITEM(__pyx_1, 1, __pyx_v_lat);
      __pyx_2 = PyDict_New(); if (!__pyx_2) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 350; goto __pyx_L1;}
      if (PyDict_SetItem(__pyx_2, __pyx_n_radians, __pyx_v_radians) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 350; goto __pyx_L1;}
      __pyx_5 = PyEval_CallObjectWithKeywords(__pyx_3, __pyx_1, __pyx_2); if (!__pyx_5) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 350; goto __pyx_L1;}
      Py_DECREF(__pyx_3); __pyx_3 = 0;
      Py_DECREF(__pyx_1); __pyx_1 = 0;
      Py_DECREF(__pyx_2); __pyx_2 = 0;
      __pyx_3 = __Pyx_UnpackItem(__pyx_5, 0); if (!__pyx_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 350; goto __pyx_L1;}
      Py_DECREF(__pyx_v_outx);
      __pyx_v_outx = __pyx_3;
      __pyx_3 = 0;
      __pyx_1 = __Pyx_UnpackItem(__pyx_5, 1); if (!__pyx_1) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 350; goto __pyx_L1;}
      Py_DECREF(__pyx_v_outy);
      __pyx_v_outy = __pyx_1;
      __pyx_1 = 0;

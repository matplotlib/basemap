...
# central meridian).  latitude bounds are given for 17N, which covers Florida.
m =\
Basemap(projection='tmerc',lon_0=lon_0,lat_0=lat_0,k_0=0.9996,rsphere=(6378137.00,6356752.314245179),\
        llcrnrlon=lon_0-3,llcrnrlat=24,urcrnrlon=lon_0+3.,urcrnrlat=32,resolution='i')
x0,y0 = m(lon_0,lat_0)
x1,y1 = m(miamilon,miamilat)
# compute coordinate offsets (Basemap coordinate system has x=0,y=0 at lower
